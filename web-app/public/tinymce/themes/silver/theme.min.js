...
!(function () {
  ...
  const rn = (e) => {
    ...
    ln = { value: rn, error: an, fromOption: (e, t) => e.fold(() => an(t), rn) }
  var cn
  !(function (e) {
  ...
  const vl = (e, t, o) => {
    ...
    Cl = (e, t) =>
      ((e, o) => {
        const n = e.dom
        return n.parentNode
          ? yl(ze(n.parentNode), (o) => !Ze(e, o) && Ke(o, t))
          : A.none()
      })(e),
  ...
  const Xc = "data-alloy-vertical-dir",
    Kc = (e) =>
      wl(
        e,
        (e) => $e(e) && kt(e, "data-alloy-vertical-dir") === Yc.BottomToTop,
      ),
    Jc = () =>
      ys("layouts", [
        rs("onLtr"),
                  ...
                  r(n, a, o, e, t).fold(
                    () => {
                      ;((o, n) => {
                        ...
                        e.focusInside === jg.OnEnterOrSpaceMode &&
                          r &&
                          Ns(o, n) &&
                          s(e).each((s) => {
                            s(o, e, t), n.stop()
    ...
    xh = (e, t) => {
      bc(() => {
        ;((o, n, s) => {
          ...
          const i = ((e, t, o) => sl(e, t, (t, n) => rl(e, n, t, o)))(
              e.element,
              t,
  ...
  const Ph = () => {
    ...
    Gh = (e) => {
      ;(fc(e.element).isNone() || Bh.isFocused(e)) &&
        (Bh.isFocused(e) || Bh.focus(e), Rr(e, Wh, { item: e }))
    },
    qh = (e) => {
      Rr(e, jh, { item: e })
    },
    ...
    Qh = [
      ...
      wi("builder", (e) => ({
        ...
        behaviours: Xu(e.itemBehaviours, [
          ...
          ju.config({ store: { mode: "memory", initialValue: e.data } }),
    ...
    nf = es("type", { widget: of, item: Qh, separator: Zh }),
    sf = y([
      wm({
        factory: {
          sketch: (e) => {
    ...
    lf = qm({
      ...
      factory: (e, t, o, n) => ({
        ...
        behaviours: qu(e.menuBehaviours, [
          ...
          ju.config({ store: { mode: "memory", initialValue: e.value } }),
        ...
        events: Hr([
          Wr(Xh(), (e, t) => {
            ...
            e.getSystem()
              .getByDom(o.target)
              .each((o) => {
                wg.highlight(e, o), t.stop(), Rr(e, af(), { menu: e, item: o })
              })
          }),
          Wr(Yh(), (e, t) => {
  ...
  const ff = y("collapse-item"),
    bf = Gm({
      ...
      configFields: [
        ...
        bi("onRepositionMenu"),
        bi("onCollapseMenu"),
        ws("highlightOnOpen", hf.HighlightMenuAndItem),
          ...
          f = Hr([
            ...
            Jr((t, o) => {
              ;((t) => {
                ...
                _h.append(t, hl(o)),
                  e.onOpenMenu(t, o),
                  e.highlightOnOpen === hf.HighlightMenuAndItem
                    ? i(t, o)
                    : e.highlightOnOpen === hf.HighlightJustMenu && a(t, o)
              })
            }),
            Wr(gf, (t, o) => {
      ...
      extraApis: {
        ...
        collapseItem: (e) => ({ value: Di(ff()), meta: { text: e } }),
      },
    }),
    vf = Gm({
      name: "InlineView",
      ...
      factory: (e, t) => {
        const o = (t, o, n, s) => {
          ...
          n = (t, o, n, s) => {
            ...
            ku.open(t, r), ju.setValue(t, A.some({ mode: "menu", menu: r }))
          },
          s = (t) => {
            ku.isOpen(t) &&
              ju.getValue(t).each((o) => {
                switch (o.mode) {
                  case "menu":
        ...
        return {
          ...
          behaviours: qu(e.inlineBehaviours, [
            ...
            ju.config({ store: { mode: "memory", initialValue: A.none() } }),
            dc.config({
              channels: {
                ...Au({
  ...
  var xf,
    yf,
    wf = tinymce.util.Tools.resolve("tinymce.util.Delay"),
  ...
  const Of = (e) => (t) => t.options.get(e),
    ...
    Tf = (e) => {
      ...
      n("skin", { processor: (e) => r(e) || !1 === e, default: "oxide" }),
        ...
        n("toolbar_location", { processor: "string", default: yf.auto }),
    ...
    Ff = _f(Of("max_width")),
    Rf = _f(Of("max_height")),
    Nf = _f(Of("style_formats")),
    zf = Of("style_formats_merge"),
    Vf = Of("style_formats_autohide"),
    Lf = Of("content_langs"),
    Hf = Of("removed_menuitems"),
    Pf = Of("toolbar_mode"),
    Uf = Of("toolbar_groups"),
    Wf = Of("toolbar_location"),
    jf = Of("fixed_toolbar_container"),
    $f = Of("fixed_toolbar_container_target"),
    Gf = Of("toolbar_persist"),
    qf = Of("toolbar_sticky_offset"),
    Yf = Of("menubar"),
    Xf = Of("toolbar"),
    Kf = Of("file_picker_callback"),
    Jf = Of("file_picker_validator_handler"),
    Qf = Of("font_size_input_default_unit"),
    Zf = Of("file_picker_types"),
    eb = Of("typeahead_urls"),
    tb = Of("anchor_top"),
    ob = Of("anchor_bottom"),
    nb = Of("draggable_modal"),
    sb = Of("statusbar"),
    rb = Of("elementpath"),
    ab = Of("branding"),
    ib = Of("resize"),
    ...
    mb = Of("default_font_stack"),
    gb = Of("skin"),
    pb = (e) => !1 === e.options.get("skin"),
    hb = (e) => !1 !== e.options.get("menubar"),
    fb = (e) => {
  ...
  var Lb = Object.freeze({
    ...
    Hb = [ws("tabAttr", "data-alloy-tabstop")]
  const Pb = ua({ fields: Hb, name: "tabstopping", active: Lb }),
    Ub = Di("tooltip.exclusive"),
    Wb = Di("tooltip.show"),
    jb = Di("tooltip.hide"),
    $b = Di("tooltip.immediateHide"),
    Gb = Di("tooltip.immediateShow"),
    qb = (e, t, o) => {
      e.getSystem().broadcastOn([Ub], {})
    }
  var Yb = Object.freeze({
      __proto__: null,
      hideAllExclusive: qb,
      immediateOpenClose: (e, t, o, n) => Fr(e, n ? Gb : $b),
        ...
        return Hr(
          G([
            [
              ...
              Wr(ur(), (e, t) => {
                const n = t
                n.universal || (F(n.channels, Ub) && o(e))
              }),
              Qr((e) => {
                o(e)
              }),
  ...
  /*! @license DOMPurify 3.1.7 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.1.7/LICENSE */ let {
    ...
    { apply: iv, construct: lv } = "undefined" != typeof Reflect && Reflect // eslint-disable-line import/no-mutable-exports
  sv ||
    (sv = function (e) {
      return e
    }),
  ...
  const cv = Sv(Array.prototype.forEach),
    dv = Sv(Array.prototype.pop),
    uv = Sv(Array.prototype.push),
    mv = Sv(String.prototype.toLowerCase),
    gv = Sv(String.prototype.toString),
    pv = Sv(String.prototype.match),
    hv = Sv(String.prototype.replace),
    fv = Sv(String.prototype.indexOf),
    bv = Sv(String.prototype.trim),
    vv = Sv(Object.prototype.hasOwnProperty),
    xv = Sv(RegExp.prototype.test),
    yv =
      ((wv = TypeError),
      function () {
  ...
  function Cv(e, t) {
    let o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : mv
    ev &&
   ...
   */ function kv(e) {
    for (let t = 0; t < e.length; t++) vv(e, t) || (e[t] = null)
    return e
  }
  /**
  ...
  var Kv = (function e() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Xv()
    const o = (t) => e(t)
    /**
    ...
    let { IS_ALLOWED_URI: z } = Yv,
      V = null
    /**
     * We consider the elements and attributes below to be safe. Ideally
     * don't add any new ones but feel free to remove unwanted ones.
     */
    /* allowed element names */ const L = Cv({}, [
      ...Tv,
      ...Ev,
      ...Av,
      ...Dv,
    ...
    const ue = Cv({}, ["audio", "video", "img", "source", "image", "track"])
    ...
    const Oe = n.createElement("form"),
      ...
      Te = function () {
        ...
        if (!ke || ke !== e) {
          if (
            ...
            (V = vv(e, "ALLOWED_TAGS") ? Cv({}, e.ALLOWED_TAGS, Ce) : L),
            (H = vv(e, "ALLOWED_ATTR") ? Cv({}, e.ALLOWED_ATTR, Ce) : P),
            (xe = vv(e, "ALLOWED_NAMESPACES")
              ? Cv({}, e.ALLOWED_NAMESPACES, gv)
              : ye),
            (me = vv(e, "ADD_URI_SAFE_ATTR")
              ? Cv(
                  Ov(ge),
            ...
            (de = vv(e, "ADD_DATA_URI_TAGS")
              ...
              : ue),
            (le = vv(e, "FORBID_CONTENTS")
              ? Cv({}, e.FORBID_CONTENTS, Ce)
              : ce),
            (W = vv(e, "FORBID_TAGS") ? Cv({}, e.FORBID_TAGS, Ce) : {}),
            (j = vv(e, "FORBID_ATTR") ? Cv({}, e.FORBID_ATTR, Ce) : {}),
            (ie = !!vv(e, "USE_PROFILES") && e.USE_PROFILES),
            ($ =
              !1 !==
              e.ALLOW_ARIA_ATTR), // Default true
            (G =
              !1 !==
              e.ALLOW_DATA_ATTR), // Default true
            (q =
              e.ALLOW_UNKNOWN_PROTOCOLS ||
              !1), // Default false
            (Y =
              !1 !==
              e.ALLOW_SELF_CLOSE_IN_ATTR), // Default true
            (X =
              e.SAFE_FOR_TEMPLATES ||
              !1), // Default false
            (K =
              !1 !==
              e.SAFE_FOR_XML), // Default true
            (J =
              e.WHOLE_DOCUMENT ||
              !1), // Default false
            (ee =
            ...
            (ne =
              !1 !==
              e.SANITIZE_DOM), // Default true
            (se =
              e.SANITIZE_NAMED_PROPS ||
              !1), // Default false
            (re =
              !1 !==
              e.KEEP_CONTENT), // Default true
            (ae =
              e.IN_PLACE ||
              !1), // Default false
            (z = e.ALLOWED_URI_REGEXP || Wv),
            (be = e.NAMESPACE || fe),
            ...
            /* Parse profile info */ ie &&
              ((V = Cv({}, Iv)),
              (H = []),
              !0 === ie.html && (Cv(V, Tv), Cv(H, Fv)),
              !0 === ie.svg && (Cv(V, Ev), Cv(H, Rv), Cv(H, zv)),
              !0 === ie.svgFilters && (Cv(V, Av), Cv(H, Rv), Cv(H, zv)),
              !0 === ie.mathMl && (Cv(V, Dv), Cv(H, Nv), Cv(H, zv))),
            /* Merge configuration parameters */ e.ADD_TAGS &&
              (V === L && (V = Ov(V)), Cv(V, e.ADD_TAGS, Ce)),
            e.ADD_ATTR && (H === P && (H = Ov(H)), Cv(H, e.ADD_ATTR, Ce)),
            e.ADD_URI_SAFE_ATTR && Cv(me, e.ADD_URI_SAFE_ATTR, Ce),
            e.FORBID_CONTENTS &&
              (le === ce && (le = Ov(le)), Cv(le, e.FORBID_CONTENTS, Ce)),
      ...
      Ee = Cv({}, ["mi", "mo", "mn", "ms", "mtext"]),
      Ae = Cv({}, ["annotation-xml"]),
      Me = Cv({}, ["title", "style", "font", "a", "script"]),
      De = Cv({}, [...Ev, ...Av, ...Mv]),
      Be = Cv({}, [...Dv, ...Bv]),
      Ie = function (e) {
        uv(o.removed, { element: e })
        try {
      ...
      Fe = function (e, t) {
        try {
          uv(o.removed, { attribute: t.getAttributeNode(e), from: t })
        } catch (e) {
          uv(o.removed, { attribute: null, from: t })
        }
      ...
      He = function (e) {
        ...
        /* Remove element if anything forbids its presence */ if (
          ...
          if (!W[n] && Ue(n)) {
            if (U.tagNameCheck instanceof RegExp && xv(U.tagNameCheck, n))
              return !1
        ...
        /* Check whether element has a valid namespace */ return e instanceof
          ...
          : /* Make sure that older browsers don't get fallback-tag mXSS */
            ("noscript" !== n && "noembed" !== n && "noframes" !== n) ||
              !xv(/<\/no(script|embed|frames)/i, e.innerHTML)
            ? /* Sanitize element content to be template-safe */
              (X &&
                ...
                e.textContent !== t &&
                  (uv(o.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
        ...
        /* Allow valid data-* attributes: At least one character after "-"
          ...
          if (
            ...
            !(
              ...
              ("is" === t &&
                U.allowCustomizedBuiltInElements &&
                ((U.tagNameCheck instanceof RegExp && xv(U.tagNameCheck, o)) ||
      ...
      Ue = function (e) {
        return "annotation-xml" !== e && pv(e, N)
      },
      We = function (e) {
        /* Execute a hook if present */
        ...
        /* Go backwards over all attributes; safely remove bad ones */ for (
          ...
          if (
            ...
            (n.keepAttr = !0),
            (n.forceKeepAttr =
              void 0), // Allows developers to see this is a property they can set
    ...
    return (
      (o.sanitize = function (e) {
        ...
        /* Serialize doctype if allowed */ return (
          J &&
            ...
            xv(Gv, n.ownerDocument.doctype.name) &&
      ...
      (o.addHook = function (e, t) {
        "function" == typeof t && ((E[e] = E[e] || []), uv(E[e], t))
      }),
      /**
       * RemoveHook
  ...
  const Jv = (e) => Kv().sanitize(e)
  var Qv = tinymce.util.Tools.resolve("tinymce.util.I18n")
  const Zv = {
      indent: !0,
      outdent: !0,
    ...
    ex = "temporary-placeholder",
    tx = (e) => () => fe(e, ex).getOr("!not found!"),
    ox = (e, t) => {
    ...
    ax = (e, t, o, n) => {
      var s, r
      const a = ((e) => !!Qv.isRtl() && be(Zv, e))(t) ? ["tox-icon--flip"] : [],
        i = fe(o, ox(t, o)).or(n).getOrThunk(tx(o))
      return {
        dom: {
          tag: e.tag,
    ...
    cx = Gm({
      ...
      factory: (e) => {
        const t = Di("notification-text"),
          o = Vb({
            dom: zb(
              `<p id=${t}>${Jv(e.backstageProvider.translate(e.text))}</p>`,
            ),
            behaviours: ca([_h.config({})]),
          }),
          n = (e) => ({
          ...
          i = G([
            e.icon.toArray(),
            e.level.toArray(),
            e.level.bind((e) => A.from(lx[e])).toArray(),
          ]),
          l = Vb(
            Nb.sketch({
              dom: {
    ...
    return {
      open: (t, l, c) => {
        ...
        if (n.isSet()) {
          ...
          n.set(t), o.add(t), vf.showWithinBounds(t, i, { anchor: c }, a)
        }
        h(t.timeout) &&
          t.timeout > 0 &&
          wf.setEditorTimeout(
  ...
  var mx = ux
  const gx = "tox-menu-nav__js",
    px = "tox-collection__item",
    hx = "tox-swatch",
    fx = { normal: gx, color: hx },
    bx = "tox-collection__item--enabled",
    vx = "tox-collection__item-icon",
    xx = "tox-collection__item-label",
    yx = "tox-collection__item-caret",
    wx = "tox-collection__item--active",
    Sx = "tox-collection__item-container",
    Cx = "tox-collection__item-container--row",
    kx = (e) => fe(fx, e).getOr(gx),
    Ox = (e) => ("color" === e ? "tox-swatches" : "tox-menu"),
    _x = (e) => ({
    ...
    Nx = Di("refetch-trigger-event"),
    zx = Di("redirect-menu-item-interaction"),
    Vx = "tox-menu__searcher",
    Lx = (e) =>
      Ol(e.element, `.${Vx}`).bind((t) =>
        e.getSystem().getByDom(t).toOptional(),
      ),
    Hx = Lx,
    Px = (e) => ({
    ...
    Ux = (e) => {
      const t = (e, t) => (t.cut(), A.none()),
        o = (e, t) => {
          ...
          return Rr(e, zx, o), A.some(!0)
        },
        n = "searcher-events"
      return {
        dom: { tag: "div", classes: [px] },
        components: [
          Rx.sketch({
            inputClasses: [Vx, "tox-textfield"],
            inputAttributes: {
              ...e.placeholder
    ...
    qx = (e, t, o) =>
      lf.parts.items({
        preprocess: (n) => {
          const s = V(n, o)
          return "auto" !== e && e > 1
            ? $x({ tag: "div", classes: ["tox-collection__group"] }, e)(s)
            : Gx(s, (e, o) => "separator" === t[o].type)
        },
      }),
    Yx = (e, t, o = !0) => ({
      dom: {
    ...
    Xx = (e) => R(e, (e) => "icon" in e && void 0 !== e.icon),
    Kx = (e) => (console.error(Zn(e)), console.log(e), A.none()),
    Jx = (e, t, o, n, s) => {
      const r =
        ((a = o),
        {
          ...
          components: [
            lf.parts.items({
              preprocess: (e) => Gx(e, (e, t) => "separator" === a[t].type),
            }),
          ],
        })
      var a
    ...
    Qx = (e, t, o, n, s) => {
          ...
          components: [
            {
              ...
              components: [
                lf.parts.items({
                  preprocess:
                    "auto" !== e
                      ? $x({ tag: "div", classes: ["tox-swatches__row"] }, e)
                      : w,
                }),
              ],
            },
            ...
            : "search-with-field" === s.searchMode.searchMode
              ? ((e, t, o) => {
                  ...
                  return {
                    ...
                    components: [
                      Ux({ i18n: Qv.translate, placeholder: o.placeholder }),
                      {
                        dom: {
                          tag: "div",
                          classes: [
              ...
              : ((e, t, o = !0) => {
                  ...
                  return {
                    dom: {
                      tag: "div",
                      classes: ["tox-menu", "tox-collection", Wx].concat(
                        1 === e
                          ? ["tox-collection--list"]
                          : ["tox-collection--grid"],
                      ),
      ...
      return { value: e, dom: Ex(t, n, s.menuType), components: Ax, items: o }
    },
    Zx = is("type"),
    ey = is("name"),
    ty = is("label"),
    ...
    Ey = Fn([Zx, my]),
    Ay = Fn([_y("autocompleteitem"), xy, wy, ky, ry, my, py]),
    My = [wy, hy, py, my, dy, ks("context", "mode:design")],
    Dy = Fn([Zx, ly, by].concat(My)),
    By = (e) => Kn("toolbarbutton", Dy, e),
    Iy = [xy].concat(My),
    Fy = Fn(Iy.concat([Zx, ly, by])),
    Ry = (e) => Kn("ToggleButton", Fy, e),
    Ny = [
      Ts("predicate", T),
    ...
    Ly = My.concat([_y("contextformbutton")]),
    Hy = Iy.concat([_y("contextformtogglebutton")]),
    Py = [
      fy,
      ms(
        "commands",
        es("type", { contextformbutton: zy, contextformtogglebutton: Vy }),
      ),
      ps(
        "launch",
        es("type", { contextformbutton: Ly, contextformtogglebutton: Hy }),
      ),
      Ts("onInput", b),
      Ts("onSetup", b),
    ],
    ...
    Yy = [Zx, is("src"), fs("alt"), Es("classes", [], Un)],
    Xy = Fn(Yy),
    Ky = [Zx, oy, uy, Es("classes", ["tox-collection__item-label"], Un)],
    Jy = Fn(Ky),
    Qy = Dn(() =>
      qn("type", { cardimage: Xy, cardtext: Jy, cardcontainer: Zy }),
    ),
    Zy = Fn([
      Zx,
  ...
  const tw = Fn([Zx, fy, ms("items", Qy), dy, Oy].concat(ew)),
    ow = Fn([Zx, xy, py].concat(ew)),
    nw = [Zx, is("fancytype"), Oy],
    sw = [ws("initData", {})].concat(nw),
    rw = [
      vs("select"),
      As("initData", {}, [
    ...
    aw = es("fancytype", { inserttable: sw, colorswatch: rw }),
    iw = Fn([Zx, dy, Oy, py].concat(ew)),
    lw = Fn([Zx, iy, dy, py].concat(ew)),
    cw = Fn([Zx, py, xy, dy, ly].concat(ew)),
    dw = (e, t, o) => {
    ...
    uw = (e) => ((e, t) => ca([Th(e, t)]))(Di("unnamed-events"), e),
    mw = (e) =>
      ug.config({
        disabled: e,
        disableClass: "tox-collection__item--state-disabled",
      }),
    gw = (e) => ug.config({ disabled: e }),
    pw = (e) => ug.config({ disabled: e, disableClass: "tox-tbtn--disabled" }),
    hw = (e) =>
      ug.config({
        disabled: e,
      ...
      e.on("init SwitchMode", (e) => {
        ...
        e.on("DisabledStateChange", (o) => {
          if (!o.isDefaultPrevented()) {
            const n = o.state ? yw : ww
            Cw(t, n), o.state || e.nodeChanged()
          }
        }),
        e.on("NodeChange", (o) => {
          const n = e.ui.isEnabled() ? o.type : yw
          Cw(t, n)
        }),
    ...
    Ow = (e) =>
      dc.config({
        channels: {
          [xw]: {
            onReceive: (t, o) => {
              if (o === yw || "setEnabled" === o)
                return void ug.set(t, o === yw)
              const { contextType: n, shouldDisable: s } = e()
              ;("mode" !== n || F(Sw, o)) && ug.set(t, s)
            },
          },
        },
      }),
    ...
    Aw = (e, t, o, n) => {
      ...
      return {
        type: "item",
        dom: t.dom,
        components: Ew(t.optComponents),
        data: e.data,
        eventOrder: Tw,
        hasSubmenu: e.triggersSubmenu,
        itemBehaviours: ca(
          [
            Th("item-events", [_w(e, o), bw(e, s), vw(e, s)]),
            mw(
              () =>
                !e.enabled ||
                n.checkUiComponentContext(e.context).shouldDisable,
            ),
            Ow(() => n.checkUiComponentContext(e.context)),
            _h.config({}),
    ...
    Bw = (e, t, o = [vx]) => ix(e, { tag: "div", classes: o }, t),
    Iw = (e) => ({
      dom: { tag: "div", classes: [xx] },
      components: [dl(Qv.translate(e))],
    }),
    Fw = (e, t) => ({ dom: { tag: "div", classes: t, innerHtml: e } }),
    Rw = (e, t) => ({
      dom: { tag: "div", classes: [xx] },
      components: [
        {
          dom: { tag: e.tag, styles: e.styles },
          components: [dl(Qv.translate(t))],
        },
      ],
    }),
    Nw = (e) => ({
    ...
    zw = (e) => Bw("checkmark", e, ["tox-collection__item-checkmark"]),
    Vw = (e) => {
      const t = e
        .map((e) => ({
          attributes: { id: Di("menu-item"), "aria-label": Qv.translate(e) },
        }))
        .getOr({})
      return { tag: "div", classes: [gx, px], ...t }
    },
    Lw = (e, t, o, n = A.none()) =>
      "color" === e.presets
        ? ((e, t, o) => {
            const n = e.value,
              s = e.iconContent.map((e) =>
                ((e, t, o) => {
                  const n = t()
                  return nx(e, n).or(o).getOrThunk(tx(n))
                })(e, t.icons, o),
              ),
              r = e.ariaLabel
                .map((e) => ({
        ...
        : ((e, t, o, n) => {
            const s = { tag: "div", classes: [vx] },
              r = o
                ? e.iconContent
                    .map((e) => ix(e, s, t.icons, n))
                    .orThunk(() => A.some({ dom: s }))
                : A.none(),
              a = e.checkMark,
              i = A.from(e.meta).fold(
                () => Iw,
                (e) => (be(e, "style") ? C(Rw, e.style) : Iw),
              ),
            ...
            return {
              dom: Vw(e.ariaLabel),
              optComponents: [r, l, e.shortcutContent.map(Nw), a, e.caret],
            }
          })(e, t, o, n),
    Hw = (e, t, o) =>
      fe(e, "tooltipWorker")
        .map((e) => [
          Qb.config({
            ...
            onShow: (t, o) => {
              e((e) => {
                Qb.setComponents(t, [ul({ element: ze(e) })])
              })
            },
          }),
        ])
    ...
    Pw = (e, t) => {
      const o = ((e) => Sf.DOM.encode(e))(Qv.translate(e))
      if (t.length > 0) {
        const e = new RegExp(
          ((e) => e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"))(t),
          "gi",
      ...
      V(e, (e) => {
        switch (e.type) {
          ...
          case "cardtext":
            ...
            return Fw(Pw(e.text, n), e.classes)
        }
      }),
    Ww = Om(ef(), tf()),
    jw = (e) => ({ value: Yw(e) }),
    $w = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
    Gw = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i,
    qw = (e) => $w.test(e) || Gw.test(e),
    Yw = (e) => Oe(e, "#").toUpperCase(),
    Xw = (e) => {
      const t = e.toString(16)
      return (1 === t.length ? "0" + t : t).toUpperCase()
    },
    Kw = (e) => {
      const t = Xw(e.red) + Xw(e.green) + Xw(e.blue)
      return jw(t)
    },
    Jw = Math.min,
    Qw = Math.max,
    Zw = Math.round,
    eS = /^\s*rgb\s*\(\s*(\d+)\s*[,\s]\s*(\d+)\s*[,\s]\s*(\d+)\s*\)\s*$/i,
    tS =
      /^\s*rgba\s*\(\s*(\d+)\s*[,\s]\s*(\d+)\s*[,\s]\s*(\d+)\s*[,\s]\s*((?:\d?\.\d+|\d+)%?)\s*\)\s*$/i,
    oS = (e, t, o, n) => ({ red: e, green: t, blue: o, alpha: n }),
    nS = (e) => {
    ...
    sS = (e) => {
      ...
      let r = e.saturation / 100,
        a = e.value / 100
      if (((r = Qw(0, Jw(r, 1))), (a = Qw(0, Jw(a, 1))), 0 === r))
        return (t = o = n = Zw(255 * a)), oS(t, o, n, 1)
      const i = s / 60,
        l = a * r,
    ...
    iS = (e) => {
      const t = eS.exec(e)
      if (null !== t) return A.some(aS(t[1], t[2], t[3], "1"))
      const o = tS.exec(e)
      return null !== o ? A.some(aS(o[1], o[2], o[3], o[4])) : A.none()
    },
    lS = (e) => `rgba(${e.red},${e.green},${e.blue},${e.alpha})`,
    cS = oS(255, 0, 0, 1),
    dS = (e, t) => {
    ...
    xS = (e, t) => () => e.execCommand(t)
  var yS = tinymce.util.Tools.resolve("tinymce.util.LocalStorage")
  const wS = {},
    SS = (e) =>
      fe(wS, e).getOrThunk(() => {
        const t = `tinymce-custom-colors-${e}`,
          o = yS.getItem(t)
        if (m(o)) {
          const e = yS.getItem("tinymce-custom-colors")
          yS.setItem(t, g(e) ? e : "[]")
        }
        const n = ((e, t = 10) => {
          const o = yS.getItem(e),
            n = r(o) ? JSON.parse(o) : [],
    ...
    kS = (e, t, o) => ({ hue: e, saturation: t, value: o }),
    OS = (e) => {
      let t = 0,
        o = 0,
        n = 0
      ...
      return i === l
        ...
        : ((t = s === i ? 3 : a === i ? 1 : 5),
          ...
          (o = (l - i) / l),
          (n = l),
          kS(Math.round(t), Math.round(100 * o), Math.round(100 * n)))
    },
    _S = (e) => Kw(sS(e)),
    TS = "forecolor",
    ES = "hilitecolor",
    ...
    MS = (e) => (t) => t.options.get(e),
    DS = "#000000",
    BS = (e, t) =>
      t === TS && e.options.isSet("color_map_foreground")
        ? MS("color_map_foreground")(e)
        : t === ES && e.options.isSet("color_map_background")
          ? MS("color_map_background")(e)
          : e.options.isSet("color_map_raw")
            ? MS("color_map_raw")(e)
            : MS("color_map")(e),
    IS = (e, t = "default") =>
      Math.max(5, Math.ceil(Math.sqrt(BS(e, t).length))),
    FS = (e, t) => {
      const o = MS("color_cols")(e),
        n = IS(e, t)
      return o === IS(e) ? n : o
    },
    RS = (e, t = "default") =>
      Math.round(
        t === TS
          ? MS("color_cols_foreground")(e)
          : t === ES
            ? MS("color_cols_background")(e)
            : MS("color_cols")(e),
      ),
    NS = MS("custom_colors"),
    zS = MS("color_default_foreground"),
    VS = MS("color_default_background"),
    LS = (e, t) => {
    ...
    PS = (e, t, o, n) => {
      "custom" === o
        ? KS(e)((o) => {
            o.each((o) => {
              CS(t, o), e.execCommand("mceApplyTextcolor", t, o), n(o)
            })
          }, LS(e, t).getOr(DS))
        : "remove" === o
    ...
    YS = (e, t, o, n) => {
      e.ui.registry.addSplitButton(t, {
        tooltip: qS(e, o, n.get()),
        presets: "color",
        icon: "forecolor" === t ? "text-color" : "highlight-bg-color",
        select: GS(e, o),
        columns: RS(e, o),
        fetch: WS(BS(e, o), o, NS(e)),
        onAction: (t) => {
          PS(e, o, n.get(), b)
        },
        onItemAction: (s, r) => {
          PS(e, o, r, (o) => {
            n.set(o), uS(e, { name: t, color: o })
          })
        },
        onSetup: (s) => {
          jS(s, t, n.get())
          const r = (n) => {
            n.name === t && (jS(s, n.name, n.color), $S(s, qS(e, o, n.color)))
          }
          return (
    ...
    XS = (e, t, o, n, s) => {
      e.ui.registry.addNestedMenuItem(t, {
        text: n,
        icon: "forecolor" === t ? "text-color" : "highlight-bg-color",
        onSetup: (n) => ($S(n, qS(e, o, s.get())), jS(n, t, s.get()), hS(e)(n)),
        getSubmenuItems: () => [
          {
            type: "fancymenuitem",
    ...
    JS = (e, t, o, n, s, r, a, i) => {
      const l = Xx(t),
        c = QS(t, o, n, "color" !== s ? "normal" : "color", r, a, i)
      return Qx(e, l, c, n, { menuType: s })
    },
    QS = (e, t, o, n, s, r, a) =>
      ye(
        V(e, (i) => {
          return "choiceitem" === i.type
            ? ((l = i), Kn("choicemenuitem", ow, l)).fold(Kx, (i) =>
                A.some(
                  ((e, t, o, n, s, r, a, i = !0) => {
                    const l = Lw(
                        {
                          ...
                          checkMark: t ? A.some(zw(a.icons)) : A.none(),
                          caret: A.none(),
                          value: e.value,
                        },
                        a,
    ...
    oC = (e, t, o) => {
      ...
      return pl({
        ...
        behaviours: ca([
          ...
          Bh.config({ onFocus: (o) => Rr(o, eC, { row: e, col: t }) }),
        ]),
      })
    },
    nC = (e) => q(e, (e) => V(e, hl)),
    ...
    rC = {
        ...
        return {
          ...
          components: [
            Ww.widget({
              ...
              components: nC(n).concat(r.asSpec()),
              behaviours: ca([
      ...
      colorswatch: (e, t) => {
        ...
        return {
          ...
          dom: { tag: "div", classes: ["tox-fancymenuitem"] },
          autofocus: !0,
          components: [Ww.widget(lf.sketch(r))],
        }
      },
    },
    aC = (e) => ({
      type: "separator",
      dom: { tag: "div", classes: [px, "tox-collection__group-heading"] },
  ...
  const dC = ua({ fields: lC, name: "coupling", apis: iC, state: cC }),
    uC = (e) => {
      let t = A.none(),
        o = []
      const n = (e) => {
    ...
    pC = (e) => {
      ...
      return {
        map: (t) => pC(() => e().then(t)),
        bind: (t) => pC(() => e().then((e) => t(e).toPromise())),
        anonBind: (t) => pC(() => e().then(() => t.toPromise())),
        toLazy: () => mC.nu(t),
        toCached: () => {
          let t = null
          return pC(() => (null === t && (t = e()), t))
        },
        toPromise: e,
        get: t,
      }
    },
    hC = (e) => pC(() => new Promise(e)),
    fC = (e) => pC(() => Promise.resolve(e)),
    bC = y("sink"),
    vC = y(
      ym({
        name: bC(),
    ...
    wC = (e, t, o, n, s, r, a) => (ku.close(n), fC(n)),
    SC = (e, t, o, n, s, r) => {
      const a = dC.getCoupled(o, "sandbox")
      return (ku.isOpen(a) ? wC : yC)(e, t, o, a, n, s, r)
    },
    CC = (e, t) =>
      e
        .getSystem()
    ...
    OC = (e, t, o) => {
      ...
      return {
        ...
        behaviours: Xu(e.sandboxBehaviours, [
          ju.config({ store: { mode: "memory", initialValue: t } }),
          ku.config({
            onOpen: (s, r) => {
              const a = xC(e, t)
              n.link(t.element),
    ...
    _C = (e) => {
      const t = dC.getCoupled(e, "sandbox")
      kC(t)
    },
    TC = () => [
      ws("sandboxClasses", []),
      Yu("sandboxBehaviours", [Jm, dc, ku, ju]),
    ],
    EC = y(
      [
        rs("dom"),
        ...
        Jc(),
        $u("dropdownBehaviours", [Hh, dC, bh, Bh]),
        rs("toggleClass"),
        ws("eventOrder", {}),
        gs("lazySink"),
        ws("matchWidth", !1),
      ...
      factory: (e, t, o, n) => {
        const s = (e) => {
          ...
          a = {
            ...
            refetch: (t) =>
              dC.getExistingCoupled(t, "sandbox").fold(
                () => r(t, b, hf.HighlightMenuAndItem).map(b),
                (o) => yC(e, w, t, o, n, b, hf.HighlightMenuAndItem).map(b),
              ),
            isOpen: Hh.isOn,
            close: (e) => {
              Hh.isOn(e) && r(e, b, hf.HighlightMenuAndItem).get(b)
        ...
        return {
          ...
          behaviours: qu(e.dropdownBehaviours, [
            ...
            bh.config({
              ...
              onEscape: (e, t) =>
                MC.isOpen(e) ? (MC.close(e), A.some(!0)) : A.none(),
            }),
            Bh.config({}),
          ]),
          events: Uh(
  ...
  const RC = (e, t, o, n, s) => {
      ...
      switch (e.type) {
        case "menuitem":
          return ((i = e), Kn("menuitem", iw, i)).fold(Kx, (e) =>
            A.some(
              ((e, t, o, n = !0) => {
                const s = Lw(
                  {
        ...
        case "nestedmenuitem":
          return ((e) => Kn("nestedmenuitem", lw, e))(e).fold(Kx, (e) =>
            A.some(
              ((e, t, o, n = !0, s = !1) => {
                const r = s
                  ? ((a = o.icons), Bw("chevron-down", a, [yx]))
                  : ((e) => Bw("chevron-right", e, [yx]))(o.icons)
                var a
                const i = Lw(
                  {
                    presets: "normal",
        ...
        case "togglemenuitem":
          return ((e) => Kn("togglemenuitem", cw, e))(e).fold(Kx, (e) =>
            A.some(
              ((e, t, o, n = !0) => {
                const s = Lw(
                  {
        ...
        case "separator":
          return ((e) => Kn("separatormenuitem", Ey, e))(e).fold(Kx, (e) =>
            A.some(aC(e)),
          )
        case "fancymenuitem":
          return ((e) => Kn("fancymenuitem", aw, e))(e).fold(Kx, (e) =>
            ((e, t) => fe(rC, e.fancytype).map((o) => o(e, t)))(e, o),
          )
        default:
    ...
    NC = (e, t, o, n, s, r, a) => {
      ...
      return ye(
        V(e, (e) => {
          switch (e.type) {
            case "separator":
              return ((n = e), Kn("Autocompleter.Separator", Ey, n)).fold(
                Kx,
                (e) => A.some(aC(e)),
              )
            case "cardmenuitem":
              return ((e) => Kn("cardmenuitem", tw, e))(e).fold(Kx, (e) =>
                A.some(
                  ((e, t, o, n) => {
                    const s = {
                      dom: Vw(e.label),
                      optComponents: [
                        A.some({
                          dom: { tag: "div", classes: [Sx, Cx] },
                          components: Uw(e.items, n),
                        }),
                      ],
                    }
                    return Aw(
                    ...
                    r,
                    {
                      itemBehaviours: Hw(e.meta, r, A.none()),
            ...
            default:
              return ((e) => Kn("Autocompleter.Item", Ay, e))(e).fold(Kx, (e) =>
                A.some(
                  ((e, t, o, n, s, r, a, i = !0) => {
                    const l = Lw(
                        {
    ...
    zC = (e, t, o, n, s, r) => {
      ...
      return (s ? Jx : Qx)(e, a, i, 1, l)
    },
    VC = (e) => bf.singleData(e.value, e),
    LC = (e) =>
                ...
                vf.showMenuAt(
                  ...
                  ((e, t, o, n) => {
                    ...
                    return {
                      ...
                      menu: {
                        markers: Tx(n),
                        fakeFocus: o === FC.ContentFocus,
                      },
                    }
                  })(
                    Qx("autocompleter-value", !0, o, n, { menuType: "normal" }),
                    n,
                    FC.ContentFocus,
                    "normal",
                  ),
          ...
          o.triggerEvent("keydown", e)
            ...
            : o.stopBackspace &&
              ((e) =>
                ...
                !PC(e.target, '[contenteditable="true"]'))(e) &&
              e.prevent()
        }),
        l = Dc(e, "focusin", (e) => {
    ...
    GC = Ms([{ stopped: [] }, { resume: ["element"] }, { complete: [] }]),
    qC = (e, t, o, n, s, r) => {
      const a = e(t, n),
        i = ((e, t) => {
          const o = en(!1),
      ...
      return a.fold(
        () => (r.logEventNoHandlers(t, n), GC.complete()),
        (e) => {
          const o = e.descHandler
          return (
            qi(o)(i),
            i.isStopped()
              ? (r.logEventStopped(t, e.element, o.purpose), GC.stopped())
              : i.isCut()
                ? (r.logEventCut(t, e.element, o.purpose), GC.complete())
                : rt(e.element).fold(
                    () => (
                      r.logNoParent(t, e.element, o.purpose), GC.complete()
                    ),
                    (n) => (
                      r.logEventResponse(t, e.element, o.purpose), GC.resume(n)
                    ),
                  )
          )
        },
    ...
    YC = (e, t, o, n, s, r) =>
      qC(e, t, o, n, s, r).fold(E, (n) => YC(e, t, o, n, s, r), T),
    XC = (e, t, o, n, s) => {
      const r = $C(o, n)
      return YC(e, t, o, n, r, s)
    },
    KC = () => {
      const e = (() => {
          const e = {}
    ...
    QC = (e) => {
      const t = (t) => rt(e.element).fold(E, (e) => Ze(t, e)),
        ...
        s = jC(e.element, {
          triggerEvent: (e, t) =>
            li(e, t.target, (o) =>
              ((e, t, o, n) => XC(e, t, o, o.target, n))(n, e, t, o),
            ),
        }),
        r = {
          debugInfo: y("real"),
          triggerEvent: (e, t, o) => {
            li(e, t, (s) => XC(n, e, o, t, s))
          },
          triggerFocus: (e, t) => {
            zi(e).fold(
              () => {
    ...
    ZC = y([ws("prefix", "form-field"), $u("fieldBehaviours", [Jm, ju])]),
    ek = y([
  ...
  var ok = tinymce.util.Tools.resolve("tinymce.html.Entities")
  const nk = (e, t, o, n) => {
      const s = sk(e, t, o, n)
      return tk.sketch(s)
    },
    ...
    rk = (e) => ({ tag: "div", classes: ["tox-form__group"].concat(e) }),
    ak = (e, t) =>
      tk.parts.label({
        dom: { tag: "label", classes: ["tox-label"] },
        components: [dl(t.translate(e))],
      }),
    ik = Di("form-component-change"),
    lk = Di("form-component-input"),
    ck = Di("form-close"),
    dk = Di("form-cancel"),
    uk = Di("form-action"),
    mk = Di("form-submit"),
    gk = Di("form-block"),
    pk = Di("form-unblock"),
    hk = Di("form-tabchange"),
    fk = Di("form-resize"),
    bk = (e, t, o) => {
      const n = e.label.map((e) => ak(e, t)),
        s = t.icons(),
        r = (e) => (t, o) => {
        ...
        c = tk.parts.field({
          ...
          behaviours: ca([
            ...
            Ow(() => t.checkUiComponentContext(e.context)),
            _h.config({}),
            Qb.config({
              ...t.tooltips.getConfig({
                tooltipText: "",
                onShow: (e) => {
                  Ol(e.element, "." + wx + "[data-mce-tooltip]").each((o) => {
                ...
                ;((o, n) => {
                  const r =
                    ...
                    a = V(n, (t) => {
                      ...
                      return `<div data-mce-tooltip="${l}" class="tox-collection__item${r}" tabindex="-1" data-collection-item-value="${ok.encodeAllRaw(t.value)}" aria-label="${l}">${a}${n}</div>`
                    }),
                    i =
                  ...
                  "auto" === e.columns &&
                    dw(o, 5, "tox-collection__item").each(
      ...
      var d
      return nk(n, c, ["tox-form__group--collection"], [])
    },
    vk = ["input", "textarea"],
    xk = (e) => {
      const t = Ue(e)
    ...
    yk = (e, t) => {
      ...
      Sa(o, t.invalidClass),
        t.notify.each((t) => {
          xk(e.element) && St(e.element, "aria-invalid", !1),
    ...
    wk = (e, t, o, n) => {
      ...
      ya(s, t.invalidClass),
        t.notify.each((t) => {
          xk(e.element) && St(e.element, "aria-invalid", !0),
            t.getContainer(e).each((e) => {
              oi(e, n)
            }),
            t.onInvalid(e, n)
  ...
  const Tk = ua({
    ...
    Ak = Di("color-input-change"),
    Mk = Di("color-swatch-change"),
    Dk = Di("color-picker-cancel"),
    Bk = ym({ schema: [rs("dom")], name: "label" }),
    Ik = (e) =>
      ym({
        name: e + "-edge",
        overrides: (t) =>
      ...
      overrides: (e) => {
        ...
        return {
          behaviours: ca([
            bh.config({
              mode: "special",
              onLeft: (o, n) => t.onLeft(o, e, Wk(n)),
              onRight: (o, n) => t.onRight(o, e, Wk(n)),
              onUp: (o, n) => t.onUp(o, e, Wk(n)),
              onDown: (o, n) => t.onDown(o, e, Wk(n)),
            }),
            Pb.config({}),
            Bh.config({}),
          ]),
  ...
  const $k = y("slider.change.value"),
    ...
    sO = (e) => oO(e) / 2,
    rO = (e) => nO(e) / 2,
    aO = (e, t) => (t ? e.stepSize * e.speedMultiplier : e.stepSize),
    iO = (e) => e.snapToGrid,
    lO = (e) => e.snapStart,
    cO = (e) => e.rounded,
    dO = (e, t) => void 0 !== e[t + "-edge"],
    uO = (e) => dO(e, "left"),
    mO = (e) => dO(e, "right"),
    gO = (e) => dO(e, "top"),
    pO = (e) => dO(e, "bottom"),
    hO = (e) => e.model.value.get(),
    fO = (e, t) => ({ x: e, y: t }),
    bO = (e, t) => {
      Rr(e, $k(), { value: t })
    },
    ...
    yO = (e, t, o) => Math.max(t, Math.min(o, e)),
    wO = (e) => {
      const {
          min: t,
          max: o,
    ...
    OO = "bottom",
    _O = "left",
    TO = (e) => e.element.dom.getBoundingClientRect(),
    EO = (e, t) => e[t],
    AO = (e) => {
      const t = TO(e)
      return EO(t, _O)
    ...
    HO = (e) => (t, o, n) =>
      ((e, t, o, n) => {
        const s = (e > 0 ? xO : vO)(hO(o), qk(o), Jk(o), aO(o, n))
        return VO(t, s), A.some(s)
      })(e, t, o, n).map(E),
    PO = (e, t, o, n, s, r) => {
      const a = ((e, t, o, n, s) => {
        const r = IO(e),
          a = n.bind((t) => A.some(NO(t, e))).getOr(0),
          i = s.bind((t) => A.some(NO(t, e))).getOr(r),
          l = {
            min: qk(t),
            max: Jk(t),
            range: oO(t),
  ...
  var qO = Object.freeze({
    ...
    findValueOfOffset: LO,
    getValueFromEvent: (e) => Gk(e).map((e) => e.left),
    findPositionOfValue: PO,
    setPositionFromValue: (e, t, o, n) => {
      const s = hO(o),
        r = PO(e, n.getSpectrum(e), s, n.getLeftEdge(e), n.getRightEdge(e), o),
        a = Kt(t.element) / 2
  ...
  const YO = (e, t) => {
    ...
    KO = (e) => (t, o, n) =>
      ((e, t, o, n) => {
        const s = (e > 0 ? xO : vO)(hO(o), Yk(o), Qk(o), aO(o, n))
        return YO(t, s), A.some(s)
      })(e, t, o, n).map(E),
    JO = (e, t, o, n, s, r) => {
      const a = ((e, t, o, n, s) => {
        const r = FO(e),
  ...
  var n_ = Object.freeze({
    ...
    findValueOfOffset: XO,
    getValueFromEvent: (e) => Gk(e).map((e) => e.top),
    findPositionOfValue: JO,
    setPositionFromValue: (e, t, o, n) => {
      const s = hO(o),
        r = JO(e, n.getSpectrum(e), s, n.getTopEdge(e), n.getBottomEdge(e), o),
        a = Ut(t.element) / 2
  ...
  const s_ = (e, t) => {
    ...
    a_ = (e, t) => (o, n, s) =>
      ((e, t, o, n, s) => {
        const r = e > 0 ? xO : vO,
          a = t ? hO(n).x : r(hO(n).x, qk(n), Jk(n), aO(n, s)),
          i = t ? r(hO(n).y, Yk(n), Qk(n), aO(n, s)) : hO(n).y
        return s_(o, r_(a, i)), A.some(a)
      })(e, t, o, n, s).map(E),
    i_ = a_(-1, !1),
    l_ = a_(1, !1),
    c_ = a_(-1, !0),
  ...
  const g_ = qm({
    ...
    p_ = Di("rgb-hex-update"),
    h_ = Di("slider-update"),
    f_ = Di("palette-update"),
    b_ = "form",
    v_ = [$u("formBehaviours", [ju])],
    x_ = (e) => "<alloy.field." + e + ">",
    y_ = (e, t) => ({
      uid: e.uid,
      dom: e.dom,
    ...
    w_ = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = []
            return {
              field: (t, o) => (e.push(t), Tm(b_, x_(t), o)),
              record: y(e),
            }
          })(),
          o = e(t),
          n = t.record(),
          s = V(n, (e) => vm({ name: e, pname: x_(e) }))
        return Um(b_, v_, s, y_, o)
      },
    },
    S_ = Di("valid-input"),
    C_ = Di("invalid-input"),
    k_ = Di("validating-input"),
    O_ = "colorcustom.rgb.",
    __ = {
      isEnabled: E,
      setEnabled: b,
    ...
    T_ = (e, t, o, n, s, r) => {
      const a = (e, t) => {
        ...
        i = (o, n, s) =>
          Tk.config({
            ...
            notify: {
              ...
              onValid: (e) => {
                a(!1, s), Rr(e, S_, { type: o, value: ju.getValue(e) })
              },
              onInvalid: (e) => {
                a(!0, s), Rr(e, C_, { type: o, value: ju.getValue(e) })
              },
            },
            validator: {
              validate: (t) => {
        ...
        l = (o, n, a, l, c) => {
          const d = en(__),
            u = e(O_ + "range"),
            m = tk.parts.label({ dom: { tag: "label" }, components: [dl(a)] }),
            g = tk.parts.field({
              data: c,
              factory: Rx,
              inputAttributes: {
              ...
              inputBehaviours: ca([
                ...
                Qb.config({
                  ...s({
                    ...
                    onSetup: (e) => {
                      d.set({
                        isEnabled: () => Qb.isEnabled(e),
                        setEnabled: (t) => Qb.setEnabled(e, t),
                        immediatelyShow: () => Qb.immediateOpenClose(e, !0),
                        immediatelyHide: () => Qb.immediateOpenClose(e, !1),
                      }),
                        Qb.setEnabled(e, !1)
                    },
                    onShow: (o, s) => {
              ...
              onSetValue: (e) => {
                Tk.isInvalid(e) && Tk.run(e).get(b)
              },
            }),
            p = Di("aria-invalid"),
            h = Vb(r("invalid", A.some(p), "warning")),
            f = [
              m,
              g,
              Vb({
            ...
            v = "hex" !== n ? [tk.parts["aria-descriptor"]({ text: u })] : [],
            x = f.concat(v)
          return {
            dom: {
              tag: "div",
        ...
        c = (e, t) => {
          const o = t.red,
            n = t.green,
            s = t.blue
          ju.setValue(e, { red: o, green: n, blue: s })
        },
        d = Vb({
          dom: {
            tag: "div",
        ...
        m = Gm({
          factory: () => {
            const s = {
                        ...
                        r("red")
                          ...
                          .each((t) => {
                            const o = ((e, t) => {
                              const o = Kw(t)
                              return (
                                w_.getField(e, "hex").each((t) => {
                                  Bh.isFocused(t) ||
                                    ju.setValue(e, { hex: o.value })
                                }),
                                o
                              )
                            })(e, t)
              ...
              p = (t) => ({
                label: e(O_ + t + ".label"),
                description: e(O_ + t + ".description"),
              }),
              h = p("red"),
              f = p("green"),
              b = p("blue"),
            ...
            return xn(
              w_.sketch((o) => ({
                ...
                components: [
                  o.field(
                    "red",
                    tk.sketch(l(nS, "red", h.label, h.description, 255)),
                  ),
                  o.field(
                    "green",
                    tk.sketch(l(nS, "green", f.label, f.description, 255)),
                  ),
                  o.field(
                    "blue",
                    tk.sketch(l(nS, "blue", b.label, b.description, 255)),
                  ),
                  o.field(
                    "hex",
                    tk.sketch(l(qw, "hex", v.label, v.description, "ffffff")),
                  ),
                  d.asSpec(),
                ],
                formBehaviours: ca([
                  Tk.config({ invalidClass: t("form-invalid") }),
                  Th("rgb-form-events", [Wr(S_, g), Wr(C_, m), Wr(k_, m)]),
                ]),
              })),
              {
                apis: {
                  updateHex: (e, t) => {
                    ju.setValue(e, { hex: t.value }),
                      ((e, t) => {
                        const o = rS(t)
                        c(e, o), i(o)
                      })(e, t),
    ...
    E_ = (e, t, o, n) => {
      const s = Gm({
        ...
        factory: (s) => {
          const r = T_(e, t, s.onValidHex, s.onInvalidHex, o, n),
            a = ((e, t) => {
              const o = g_.parts.spectrum({
                  dom: {
                    tag: "canvas",
                    attributes: { role: "presentation" },
              ...
              return Gm({
                ...
                apis: {
                  ...
                  setThumb: (t, o, n) => {
                    ;((t, o) => {
                      const n = OS(rS(o))
                      g_.setValue(t, { x: n.saturation, y: 100 - n.value }),
                        St(
                          t.element,
                          "aria-valuetext",
                          e([
            ...
            g = (e, t, o) => {
              l.getOpt(e).each((e) => {
                g_.setValue(e, ((e) => 100 - (e / 360) * 100)(o))
              })
            },
            p = (e, t) => {
              c.getOpt(e).each((e) => {
    ...
    A_ = () => Jm.config({ find: A.some }),
    M_ = (e) =>
      Jm.config({
        find: (t) =>
          ct(t.element, e).bind((e) => t.getSystem().getByDom(e).toOptional()),
      }),
    D_ = Fn([ws("preprocess", w), ws("postprocess", w)]),
    B_ = (e, t) => {
      const o = Qn("RepresentingConfigs.memento processors", D_, t)
      return ju.config({
        store: {
          mode: "manual",
          getValue: (t) => {
    ...
    R_ = (e) => ju.config({ store: { mode: "memory", initialValue: e } }),
    N_ = {
  ...
  var z_ = tinymce.util.Tools.resolve("tinymce.Resource")
  const V_ = (e) => be(e, "init")
  var L_ = tinymce.util.Tools.resolve("tinymce.util.Tools")
  const H_ = Di("browse.files.event"),
    P_ = (e, t, o) => {
      const n = (e, t) => {
          t.stop()
        },
        ...
        i = tk.parts.field({
          ...
          buttonBehaviours: ca([
            ...
            R_(o.getOr([])),
            Pb.config({}),
            gw(() => t.checkUiComponentContext(e.context).shouldDisable),
            Ow(() => t.checkUiComponentContext(e.context)),
          ]),
        }),
        l = {
                ...
                ;(s = o),
                  (r = n.event.files) &&
                    (ju.setValue(
                      s,
                      ((e, t) => {
                        const o = L_.explode(t.getOption("images_file_types"))
                        return P(ne(e), (e) =>
                          R(o, (t) =>
    ...
    W_ = Di("alloy-fake-before-tabstop"),
    ...
    $_ = (e) => ({
      ...
      behaviours: ca([Bh.config({ ignore: !0 }), Pb.config({})]),
    }),
    G_ = (e, t) => ({
      dom: { tag: "div", classes: ["tox-navobj", ...e.getOr([])] },
      components: [$_([W_]), t, $_([j_])],
      behaviours: ca([M_(1)]),
    }),
    q_ = (e, t) => {
    ...
    Y_ = (e, t) => {
      const o = t.element
      Ca(o, W_) ? q_(e, !0) : Ca(o, j_) && q_(e, !1)
    },
    X_ = (e) => PC(e, ["." + W_, "." + j_].join(","), T),
    K_ = Di("update-dialog"),
    J_ = Di("update-title"),
    Q_ = Di("update-body"),
    Z_ = Di("update-footer"),
    eT = Di("body-send-message"),
    tT = Di("dialog-focus-shifted"),
    oT = Mo().browser,
    nT = oT.isSafari(),
    sT = oT.isFirefox(),
    rT = nT || sT,
    aT = oT.isChromium(),
    iT = ({ scrollTop: e, scrollHeight: t, clientHeight: o }) =>
      Math.ceil(e) + o >= t,
    lT = (e, t) => e.scrollTo(0, "bottom" === t ? 99999999 : t),
    cT = (e, t, o) => {
      const n = e.dom
      A.from(n.contentDocument).fold(o, (e) => {
        ...
        const s = ((e, t) => {
          ...
          r = () => {
            ...
            g(e) && (s ? lT(e, "bottom") : !s && rT && 0 !== o && lT(e, o))
          }
        nT && n.addEventListener("load", r, { once: !0 }),
          e.open(),
          e.write(t),
          e.close(),
          nT || r()
    ...
    uT = Di("toolbar.button.execute"),
    mT = Di("common-button-display-events"),
    gT = {
      [mr()]: [
        "disabling",
      ...
      [Cr()]: ["toolbar-button-events", mT],
      [kr()]: ["toolbar-button-events", "dropdown-events", "tooltipping"],
      [js()]: ["focusing", "alloy.base.behaviour", mT],
    },
    pT = (e) => Mt(e.element, "width", It(e.element, "width")),
    hT = (e, t, o) =>
      ix(
        e,
        {
    ...
    fT = (e, t) => hT(e, t, []),
    bT = (e, t) => hT(e, t, [_h.config({})]),
    vT = (e, t, o) => ({
      dom: { tag: "span", classes: [`${t}__select-label`] },
      components: [dl(o.translate(e))],
      behaviours: ca([_h.config({})]),
    }),
    xT = Di("update-menu-text"),
    yT = Di("update-menu-icon"),
    wT = (e, t, o, n) => {
      const s = en(b),
        r = e.text.map((e) => Vb(vT(e, t, o.providers))),
        a = e.icon.map((e) => Vb(bT(e, o.providers.icons))),
        i = (e, t) => {
        ...
        h = Vb(
          MC.sketch({
            ...
            dropdownBehaviours: ca([
              ...
              Ow(() => o.providers.checkUiComponentContext(e.context)),
              Ek.config({}),
              _h.config({}),
              ...e.tooltip
                .map((e) =>
              ...
              Th(m, [
                Jr((t, o) => {
                  "listbox" !== e.listRole && pT(t)
                }),
              ]),
              Th("update-dropdown-width-variable", [
                Wr(Sr(), (e, t) => MC.close(e)),
              ]),
              Th("menubutton-update-display-text", [
                ...
                Wr(yT, (e, t) => {
                  a.bind((t) => t.getOpt(e)).each((e) => {
                    _h.set(e, [bT(t.event.icon, o.providers.icons)])
                  })
                }),
              ]),
            ]),
            eventOrder: xn(gT, {
              ...
              [Cr()]: ["toolbar-button-events", Qb.name(), p, m],
            }),
                ...
                Wr(Nx, (e, t) => {
                  ;((e) => {
                    const t = ju.getValue(e),
                      o = Lx(e).map(Px)
                    MC.refetch(t).get(() => {
                      const e = dC.getCoupled(t, "sandbox")
                      o.each((t) =>
                        Lx(e).each((e) =>
                          ((e, t) => {
                            ju.setValue(e, t.fetchPattern),
            ...
            fetch: (t) => hC(C(e.fetch, t)),
          }),
        )
      return h.asSpec()
    },
    ST = (e) => "separator" === e.type,
    CT = { type: "separator" },
    kT = (e, t) => {
      const o = ((e, t) => {
        const o = W(
        ...
        return o.length > 0 && ST(o[o.length - 1]) && o.pop(), o
      })(r(e) ? e.split(" ") : e, t)
      return U(
        o,
        (e, o) => {
    ...
    OT = (e, t, o, n) => {
      const s = Di("primary-menu"),
        r = kT(e, o.shared.providers.menuItems())
      ...
      const a = ((e) =>
        ...
        i = zC(s, r.items, t, o, n.isHorizontalMenu, a),
        l = ((e) =>
          e.search.fold(
            () => ({ searchMode: "no-search" }),
            (e) => ({ searchMode: "search-with-results" }),
          ))(n),
        c = le(r.menus, (e, n) => zC(n, e, t, o, !1, l)),
        d = xn(c, Ds(s, i))
      ...
      V(o, (o) =>
        _T(o)
          ? {
              ...
              active: o.value === n,
              onAction: () => {
                ju.setValue(e, o.value), Rr(e, ik, { name: t }), Bh.focus(e)
              },
            }
          : {
              type: "nestedmenuitem",
              text: o.text,
              getSubmenuItems: () => ET(e, t, o.items, n, s),
            },
      ),
    AT = (e, t) =>
      se(e, (e) => (_T(e) ? Ce(e.value === t, e) : AT(e.items, t))),
    MT = Gm({
      name: "HtmlSelect",
      configFields: [
        rs("options"),
        $u("selectBehaviours", [Bh, ju]),
        ws("selectClasses", []),
        ws("selectAttributes", {}),
        gs("data"),
      ],
    ...
    DT = y([
      ...
      hi(["lockClass"]),
      ws("locked", !1),
      Yu("coupledFieldBehaviours", [Jm, ju]),
      Ts("onInput", b),
    ]),
    BT = (e, t) =>
      vm({
          ...
          ju.config({
            store: {
              ...
              setValue: (t, o) => {
                ...
                ve(o, e.field1Name) && ju.setValue(n.field1(), o[e.field1Name]),
                  ve(o, e.field2Name) &&
                    ju.setValue(n.field2(), o[e.field2Name])
              },
            },
          }),
        ]),
    ...
    VT = (e, t) => {
      ...
      const n = Di("ratio-event"),
        ...
        r = () =>
          !e.enabled ||
          e.context.exists((e) => t.checkUiComponentContext(e).shouldDisable),
        a = e.context.map((e) => Ow(() => t.checkUiComponentContext(e))),
        ...
        c = FT.parts.lock({
          ...
          buttonBehaviours: ca([
            ...
            ...a.toArray(),
            Pb.config({}),
            Qb.config(t.tooltips.getConfig({ tooltipText: l })),
          ]),
        }),
        d = (t) => ({
          dom: {
            tag: "div",
            classes: [
              e.inDialog ? "tox-form__group" : "tox-context-form__group",
            ],
          },
          components: t,
        }),
          ...
          tk.parts.field({
            ...
            inputBehaviours: ca([
              ...
              Th("size-input-events", [
                ...
                Wr(er(), (t, o) => {
                  e.name.each((e) => Rr(t, ik, { name: e }))
                }),
              ]),
              ...e.onEnter
                .map((e) => bh.config({ mode: "special", onEnter: e }))
                .toArray(),
            ]),
            selectOnFocus: !1,
          }),
        ...
        g = FT.parts.field1(d([tk.parts.label(m("Width")), u(!0)])),
        p = FT.parts.field2(d([tk.parts.label(m("Height")), u(!1)])),
        h = en(b),
        f = we(e.onSetup, e.getApi, (e, t) => [
          bw({ onSetup: e, getApi: t }, h),
          vw({ getApi: t }, h),
        ]).getOr([])
      return FT.sketch({
        dom: {
          tag: "div",
          classes: [e.inDialog ? "tox-form__group" : "tox-context-form__group"],
        },
        components: [
          {
        ...
        coupledFieldBehaviours: ca([
          ug.config({
            disabled: r,
            onDisabled: (e) => {
              FT.getField1(e).bind(tk.getField).each(ug.disable),
                FT.getField2(e).bind(tk.getField).each(ug.disable),
                FT.getLock(e).each(ug.disable)
            },
            onEnabled: (e) => {
              FT.getField1(e).bind(tk.getField).each(ug.enable),
                FT.getField2(e).bind(tk.getField).each(ug.enable),
                FT.getLock(e).each(ug.enable)
            },
          }),
          Ow(() => t.checkUiComponentContext("mode:design")),
          Th("size-input-events", [
            Wr(n, (e, t) => {
              const n = t.event.isField1,
                s = n ? FT.getField1(e) : FT.getField2(e),
                r = n ? FT.getField2(e) : FT.getField1(e),
                a = s.map(ju.getValue).getOr(""),
                i = r.map(ju.getValue).getOr("")
              o = ((e, t) => {
                const o = RT(e).toOptional(),
                  n = RT(t).toOptional()
                return we(o, n, (e, t) =>
                  NT(e, t.unit)
                    .map((e) => t.value / e)
                    .map((e) => {
                      return (
                        (o = e),
                        (n = t.unit),
                        (e) => NT(e, n).map((e) => ({ value: e * o, unit: n }))
                      )
                      var o, n
                    })
                    .getOr(zT),
            ...
            Tk.config({
              ...
              validator: {
                validate: (t) => {
                  const o = ju.getValue(t),
                    n = e.validator(o)
                  return fC(!0 === n ? ln.value(o) : ln.error(n))
                },
        ...
        c = [
          ug.config({
            disabled: () =>
              e.disabled || t.checkUiComponentContext(e.context).shouldDisable,
            onDisabled: (e) => {
              tk.getField(e).each(ug.disable)
            },
            onEnabled: (e) => {
              tk.getField(e).each(ug.enable)
            },
          }),
          Ow(() => t.checkUiComponentContext(e.context)),
        ]
    ...
    PT = (e) => e.dimension.property,
    UT = (e, t) => e.dimension.getDimension(t),
    WT = (e, t) => {
      const o = HT(e, t)
    ...
    GT = (e, t, o, n) => {
      o.setCollapsed(),
        Mt(e.element, PT(t), UT(t, e.element)),
        WT(e, t),
        jT(e, t),
        t.onStartShrink(e),
        t.onShrunk(e)
    ...
    qT = (e, t, o, n) => {
      const s = n.getOrThunk(() => UT(t, e.element))
      o.setCollapsed(), Mt(e.element, PT(t), s), Lt(e.element)
      const r = HT(e, t)
      Sa(r, t.growingClass),
    ...
    YT = (e, t, o) => {
      const n = UT(t, e.element)
      ;("0px" === n ? GT : qT)(e, t, o, A.some(n))
    },
    XT = (e, t, o) => {
      const n = HT(e, t),
        ...
        r = UT(t, e.element)
      $T(e, t)
      const a = UT(t, e.element)
      ;(s
        ? () => {
            Mt(e.element, PT(t), r), Lt(e.element)
          }
        : () => {
            jT(e, t)
          })(),
  ...
  var QT = Object.freeze({
      ...
      refresh: (e, t, o) => {
        if (o.isExpanded()) {
          Vt(e.element, PT(t))
          const o = UT(t, e.element)
          Mt(e.element, PT(t), o)
        }
      },
      grow: (e, t, o) => {
        o.isExpanded() || XT(e, t, o)
      },
      shrink: (e, t, o) => {
      ...
      isGrowing: KT,
      isShrinking: JT,
      isTransitioning: (e, t, o) => KT(e, t) || JT(e, t),
      toggleGrow: (e, t, o) => {
        ;(o.isExpanded() ? YT : XT)(e, t, o)
      },
      disableTransitions: WT,
      immediateGrow: (e, t, o) => {
        o.isExpanded() ||
          ($T(e, t),
          Mt(e.element, PT(t), UT(t, e.element)),
  ...
  const tE = ua({
          ...
          n.setActive(s),
            ...
            o.shared.getSink().each((o) => {
              t()
                ...
                .each((t) => {
                  mc(t.element),
                    Rr(t, uk, { name: e.name, value: e.storage.get() })
                })
            })
        },
        s = (e) => (t) => {
    ...
    lE = ({
      ...
      const a = e.menu.map((e) => nE(e, "tox-mbtn", r, A.none(), o)),
        i = [rE(e.title)]
      return (
        aE(e, i, r),
        a.each((e) => i.push(e)),
    ...
    dE = Di("directory-label-event-id"),
    uE = ({ directory: e, visible: t, noChildren: o, backstage: n }) => {
      const s = e.menu.map((e) => nE(e, "tox-mbtn", n, A.none())),
        r = [
          {
            dom: { tag: "div", classes: ["tox-chevron"] },
            components: [
              ("chevron-right",
              (a = n.shared.providers.icons),
              cE("chevron-right", a, [])),
            ],
          },
          rE(e.title),
        ...
        behaviours: ca([
          ...
          Hh.config({
            ...
            onToggled: (e, o) => {
              ...
              var d
              o ? tE.grow(r) : tE.shrink(r), _h.set(r, c)
            },
          }),
        ]),
      }
  ...
  const yE = ua({ fields: xE, name: "streaming", active: fE, state: vE }),
    wE = (e, t, o) => {
      const n = ju.getValue(o)
      ju.setValue(t, n), CE(t)
    },
    SE = (e, t) => {
      const o = e.element,
        n = tl(o),
    ...
    CE = (e) => {
      SE(e, (e, t) => e.setSelectionRange(t.length, t.length))
    },
    kE = y("alloy.typeahead.itemexecute"),
    OE = y(
      [
        gs("lazySink"),
        rs("fetch"),
        ...
        gs("initialData"),
        gs("listRole"),
        $u("typeaheadBehaviours", [Bh, ju, yE, bh, Hh, dC]),
        ...
        overrides: (e) => ({
          ...
          onHighlightItem: (t, o, n) => {
            e.previewing.get()
              ...
              : e.lazyTypeaheadComp.get().each((t) => {
                  e.model.populateFromBrowse && wE(e.model, t, n),
          ...
          onExecute: (t, o) =>
            e.lazyTypeaheadComp
              .get()
              .map((e) => (Rr(e, kE(), { item: o }), !0)),
          onHover: (t, o) => {
            e.previewing.set(!1),
              e.lazyTypeaheadComp.get().each((t) => {
                e.model.populateFromBrowse && wE(e.model, t, o)
              })
          },
        }),
      }),
    ...
    TE = qm({
      ...
      factory: (e, t, o, n) => {
        const s = (t, o, s) => {
            e.previewing.set(!1)
            const r = dC.getCoupled(t, "sandbox")
            if (ku.isOpen(r))
              ...
              yC(e, a(t), t, r, n, o, hf.HighlightMenuAndItem).get(b)
            }
          },
          r = Bx(e),
          a = (e) => (t) =>
            t.map((t) => {
              ...
              return ju.getState(e).update(V(n, (e) => e.data)), t
            }),
          i = (e) => Jm.getCurrent(e),
          l = "typeaheadevents",
          c = [
            ...
            yE.config({
              ...
              onStream: (t, o) => {
                const s = dC.getCoupled(t, "sandbox")
                if (Bh.isFocused(t) && tl(t.element).length >= e.minChars) {
                  const o = i(s).bind((e) =>
                    wg.getHighlighted(e).map(ju.getValue),
                  )
                  e.previewing.set(!0)
                  const r = (t) => {
                    i(s).each((t) => {
                  ...
                  yC(e, a(t), t, s, n, r, hf.HighlightJustMenu).get(b)
                }
              },
              cancelEvent: br(),
            }),
            bh.config({
              ...
              onEnter: (t) => {
                const o = dC.getCoupled(t, "sandbox"),
                  n = ku.isOpen(o)
                if (n && !e.previewing.get())
                  return i(o)
                    .bind((e) => wg.getHighlighted(e))
                    .map((e) => (Rr(t, kE(), { item: e }), !0))
                {
            ...
            Th(
              ...
              [
                ...
                ea((t) => {
                  const o = b
                  SC(e, a(t), t, n, o, hf.HighlightMenuAndItem).get(b)
                }),
                Wr(kE(), (t, o) => {
                  const n = dC.getCoupled(t, "sandbox")
                  wE(e.model, t, o.event.item),
                    Fr(t, br()),
                    e.onItemExecute(t, n, o.event.item, ju.getValue(t)),
                    ku.close(n),
                    CE(t)
                }),
              ].concat(
          ...
          d = { [kr()]: [ju.name(), yE.name(), l], ...e.eventOrder }
        return {
          uid: e.uid,
          dom: Fx(
            xn(e, {
    ...
    EE = (e) => ({
      ...
      bindResult: (t) => EE(e.map((e) => e.bind(t))),
      mapResult: (t) => EE(e.map((e) => e.map(t))),
      mapError: (t) => EE(e.map((e) => e.mapError(t))),
        ...
        l = {
          buttonBehaviours: ca(
            [
              ...
              Ow(() => a.checkUiComponentContext(e.context)),
              Pb.config({}),
              ...r
                .map((e) =>
                  Qb.config(
    ...
    DE = (e, t, o, n = [], s) => {
      const r = {
        ...
        a = e.icon.map((e) => fT(e, o.icons)),
        i = Ew([a])
      return ME(e, t, n, r, i, e.tooltip, o)
    },
    BE = (e) => {
      switch (e) {
        case "primary":
    ...
    IE = (e, t, o, n = [], s = []) => {
      const r = o.translate(e.text),
        ...
        d = e.icon.map(y(r))
      return ME(e, t, n, c, i, d, o)
    },
    FE = (e, t, o, n = [], s = []) => {
      const r = IE(e, A.some(t), o, n, s)
      return Nb.sketch(r)
    },
    RE = (e, t) => (o) => {
      "custom" === t
        ? Rr(o, uk, { name: e, value: {} })
        : "submit" === t
          ? Fr(o, mk)
          : "cancel" === t
            ? Fr(o, dk)
    ...
    NE = (e, t, o) => {
      ...
      if (
        ...
        return FE(s, n, o.shared.providers, [])
      }
      if (((e, t) => "togglebutton" === t)(0, t))
        return ((e, t, o) => {
          var n, s
          const r = e.icon.map((e) => bT(e, t.icons)).map(Vb),
    ...
    HE = (e, t) =>
      ((e) => V(e, VE))(((e, t) => P(t, (t) => t.type === e))(e, t)),
    PE = (e) => HE("header", e.targets),
    UE = (e) => HE("anchor", e.targets),
    WE = (e) =>
      A.from(e.anchorTop)
        .map((e) => LE("<top>", e))
        .toArray(),
    ...
    KE = {
      ...
      collection: XE((e, t, o) => bk(e, t.shared.providers, o)),
      alertbanner: XE((e, t) =>
        ((e, t) => {
          const o = sx(e.icon, t.icons)
          return JC.sketch({
            dom: {
              tag: "div",
                ...
                components: e.url
                  ? [
                      Nb.sketch({
                        ...
                        action: (t) =>
                          Rr(t, uk, { name: "alert-banner", value: e.url }),
                        buttonBehaviours: ca([rx()]),
                      }),
                    ]
                  : void 0,
              },
      ...
      iframe:
        ((CM = (e, t, o) =>
          ((e, t, o) => {
                ...
                return {
                  ...
                  setValue: (e, n) => {
                    if (o.get() !== n) {
                      const o = e.element,
                        s = () => St(o, "srcdoc", n)
                      t ? dT.fold(y(cT), (e) => e.throttle)(o, n, s) : s()
                    }
                    o.set(n)
                  },
                }
              })(o, e.streamContent),
              l = e.label.map((e) => ak(e, t)),
              c = tk.parts.field({
                factory: {
                  sketch: (e) =>
                    G_(A.from(r), {
            ...
            return nk(l, c, ["tox-form__group--stretched"], [])
          })(e, t.shared.providers, o)),
        (e, t, o, n, s) => {
          const r = xn(t, { source: "dynamic" })
          return XE(CM)(e, r, o, n, s)
        }),
      button: XE((e, t) =>
        ((e, t) => {
          const o = RE(e.name, "custom")
          return (
            (n = A.none()),
            (s = tk.parts.field({
              factory: Nb,
              ...IE(e, A.some(o), t, [R_(""), A_()]),
            })),
            nk(n, s, [], [])
          )
          var n, s
      ...
      colorinput: XE((e, t, o) =>
        ((e, t, o, n) => {
          const s = tk.parts.field({
              factory: Rx,
              inputClasses: ["tox-textfield"],
              data: n,
              onSetValue: (e) => Tk.run(e).get(b),
              inputBehaviours: ca([
                ug.config({
                  disabled: () =>
                ...
                Ow(() => t.providers.checkUiComponentContext(e.context)),
                Pb.config({}),
                Tk.config({
                  ...
                  validator: {
                    ...
                    validate: (e) => {
                      const t = ju.getValue(e)
                      if (0 === t.length) return fC(ln.value(!0))
                      {
                        const e = Re("span")
            ...
            r = e.label.map((e) => ak(e, t.providers)),
            a = (e, t) => {
              Rr(e, Mk, { value: t })
            },
            i = Vb(
                      ...
                      A.from(
                        VC(
                          xn(
                            ...
                            { movement: ZS(e.columns, e.presets) },
                          ),
                        ),
                      ),
                    ),
                  parts: { menu: Mx(0, 0, e.presets) },
                }))(
                {
                  dom: {
                    tag: "span",
          ...
          return tk.sketch({
            ...
            fieldBehaviours: ca([
              Th("form-field-events", [
                ...
                Wr(Mk, (e, t) => {
                  tk.getField(e).each((o) => {
                    ju.setValue(o, t.event.value),
                      Jm.getCurrent(e).each(Bh.focus)
                  })
                }),
                Wr(Dk, (e, t) => {
                  tk.getField(e).each((t) => {
                    Jm.getCurrent(e).each(Bh.focus)
                  })
                }),
              ]),
      ...
      colorpicker: XE((e, t, o) =>
        ((e, t, o) => {
          const n = (e) => "tox-" + e,
            s = E_(
              (
                (e) => (t) =>
                  r(t) ? e.translate(N_[t]) : e.translate(t)
              )(t),
              n,
              t.tooltips.getConfig,
              (e, o, n = e, s = e) =>
            ...
            a = Vb(
              s.sketch({
                ...
                onValidHex: (e) => {
                  Rr(e, uk, { name: "hex-valid", value: !0 })
                },
                onInvalidHex: (e) => {
                  Rr(e, uk, { name: "hex-valid", value: !1 })
                },
              }),
            )
          return {
              ...
              I_(
                ...
                (e, t) => {
                  ...
                  Jm.getCurrent(n).fold(
                    ...
                    (e) => {
                      ju.setValue(e, { hex: o.getOr("") }),
                        w_.getField(e, "hex").each((e) => {
                          Fr(e, Zs())
                        })
                    },
                  )
      ...
      dropzone: XE((e, t, o) => P_(e, t.shared.providers, o)),
      grid: XE((e, t) =>
        ((e, t) => ({
          dom: {
            tag: "div",
      ...
      listbox: XE((e, t, o) =>
        ((e, t, o) => {
          const n = R(e.items, (e) => !_T(e)),
            s = t.shared.providers,
            r = o
              .bind((t) => AT(e.items, t))
              .orThunk(() => te(e.items).filter(_T)),
            a = e.label.map((e) => ak(e, s)),
            i = tk.parts.field({
              dom: {},
              factory: {
                sketch: (o) =>
                  wT(
                    {
                      ...
                      ariaLabel: e.label,
                      fetch: (o, s) => {
                        const r = ET(o, e.name, e.items, ju.getValue(o), n)
                        s(
                          OT(r, mx.CLOSE_ON_EXECUTE, t, {
                            isHorizontalMenu: !1,
                            search: A.none(),
                          }),
                        )
      ...
      slider: XE((e, t, o) =>
        ((e, t, o) => {
          ...
          return g_.sketch({
            ...
            components: [n, s, r],
            sliderBehaviours: ca([A_(), Bh.config({})]),
            onChoose: (t, o, n) => {
              Rr(t, ik, { name: e.name, value: n })
            },
            onChange: (t, o, n) => {
              Rr(t, ik, { name: e.name, value: n })
            },
        ...
        ((e, t, o, n) => {
          const s = t.shared.providers,
            ...
            a = {
              ...
              inputClasses: ["tox-textfield"],
              sandboxClasses: ["tox-dialog__popups"],
              inputAttributes: { "aria-errormessage": GE, type: "url" },
              minChars: 0,
              responseTime: 0,
              fetch: (n) => {
                const s = ((e, t, o) => {
                    ...
                    return o.getLinkInformation().fold(
                      ...
                      (t) => {
                        const n = $E(
                          a,
                          ((e) => V(e, (e) => LE(e, e)))(o.getHistory(e)),
                        )
                        return "file" === e
                          ? ((s = [
                              n,
                              $E(a, PE(t)),
                              $E(a, G([WE(t), UE(t), jE(t)])),
                            ]),
                            W(
                              s,
                              (e, t) =>
              ...
              onSetValue: (e, t) => {
                e.hasConfigured(Tk) && Tk.run(e).get(b)
              },
                ...
                Th("urlinput-events", [
                  Wr(Zs(), (t) => {
                    const o = tl(t.element),
                      n = o.trim()
                    n !== o && ol(t.element, n),
                      "file" === e.filetype && Rr(t, ik, { name: e.name })
                  }),
                  Wr(er(), (t) => {
                    Rr(t, ik, { name: e.name }), r(t)
                  }),
                  Wr(dr(), (t) => {
                    Rr(t, ik, { name: e.name }), r(t)
                  }),
              ...
              parts: { menu: Mx(0, 0, "normal") },
              onExecute: (e, t, o) => {
                Rr(t, mk, {})
              },
              onItemExecute: (t, o, n, s) => {
                r(t), Rr(t, ik, { name: e.name })
              },
            },
            i = tk.parts.field({ ...a, factory: TE }),
            l = e.label.map((e) => ak(e, s)),
            c = Vb(
              ((e, t, o = e, n = e) =>
                ix(
                  o,
            ...
            fieldBehaviours: ca([
              ug.config({
                disabled: () =>
                  ...
                  s.checkUiComponentContext(e.context).shouldDisable,
                onDisabled: (e) => {
                  tk.getField(e).each(ug.disable), p.getOpt(e).each(ug.disable)
                },
                onEnabled: (e) => {
                  tk.getField(e).each(ug.enable), p.getOpt(e).each(ug.enable)
                },
              }),
              Ow(() => s.checkUiComponentContext(e.context)),
              Th("url-input-events", [
                Wr(m, (t) => {
                  Jm.getCurrent(t).each((o) => {
                    ...
                    u.each((n) => {
                      n(s).get((n) => {
                        ju.setValue(o, n), Rr(t, ik, { name: e.name })
                      })
                    })
                  })
                }),
        ...
        ((e, t) => {
          ...
          return "presentation" === e.presets
            ...
            : JC.sketch({
                ...
                containerBehaviours: ca([Pb.config({}), Bh.config({}), n]),
              })
        })(e, t.shared.providers),
      ),
      imagepreview: XE((e, t, o) =>
        ((e, t) => {
      ...
      table: XE((e, t) =>
        ((e, t) => {
          ...
          return {
            ...
            behaviours: ca([Pb.config({}), Bh.config({})]),
          }
          var n, s
        })(e, t.shared.providers),
      ),
    ...
    JE = { field: (e, t) => t, record: y([]) },
    QE = (e, t, o, n, s) => {
      const r = xn(n, { shared: { interpreter: (t) => ZE(e, t, o, r, s) } })
      return ZE(e, t, o, r, s)
    },
    ZE = (e, t, o, n, s) =>
      fe(KE, t.type).fold(
    ...
    eA = (e, t, o, n) => ZE(JE, e, t, o, n),
    tA = "layout-inset",
    oA = (e) => e.x,
    nA = (e, t) => e.x + e.width / 2 - t.width / 2,
    sA = (e, t) => e.x + e.width - t.width,
    rA = (e) => e.y,
    aA = (e, t) => e.y + e.height - t.height,
    iA = (e, t) => e.y + e.height / 2 - t.height / 2,
    lA = (e, t, o) =>
      Ml(
        sA(e, t),
        aA(e, t),
    ...
    mA = (e, t, o) =>
      Ml(nA(e, t), rA(e), o.insetNorth(), Nl(), "north", Hl(e, { top: 2 }), tA),
    gA = (e, t, o) =>
      Ml(
        nA(e, t),
        aA(e, t),
    ...
    hA = (e, t, o) =>
      Ml(oA(e), iA(e, t), o.insetWest(), Vl(), "west", Hl(e, { left: 1 }), tA),
    fA = (e) => {
      switch (e) {
        case "north":
          return mA
    ...
    bA = (e, t, o, n, s) => Tc(n).map(fA).getOr(mA)(e, t, o, n, s),
    vA = (e) => {
      switch (e) {
        case "north":
          return gA
    ...
    xA = (e, t, o, n, s) => Tc(n).map(vA).getOr(mA)(e, t, o, n, s),
    yA = {
      valignCentre: [],
      alignCentre: [],
      alignLeft: [],
    ...
    OA = (e) => (t) => ({ type: "node", root: e(), node: t }),
    _A = (e, t, o, n) => {
      const s = Cb(e),
        r = () => ze(e.getBody()),
        ...
        i = () => s || !n()
      return {
        inlineDialog: wA(a, t, i),
        inlineBottomDialog: SA(e.inline, a, o, i),
        banner: CA(a, t, i),
        cursor: kA(e, r),
        node: OA(r),
      }
    ...
    GA = (e) =>
      ...
      YA(e),
    qA = (e) => e && /^(H[1-6])$/.test(e.nodeName),
    YA = (e) =>
      ((e) => {
        let t = e
        for (; (t = t.parentNode); ) {
          const e = t.contentEditable
          if (e && "inherit" !== e) return UA(t)
        }
        return !1
      })(e) && !WA(e),
    XA = (e) => qA(e) && YA(e),
    KA = (e) => {
      ...
      return jA(
        "header",
        null !== (t = $A(e)) && void 0 !== t ? t : "",
        "#" + o,
        ((e) => (qA(e) ? parseInt(e.nodeName.substr(1), 10) : 0))(e),
        () => {
          e.id = o
        },
      )
    ...
    JA = (e) => {
      const t = e.id || e.name,
        o = $A(e)
      return jA("anchor", o || "#" + t, "#" + t, 0, b)
    },
    QA = (e) => HA(e.title).length > 0,
    ZA = (e) => {
      const t = ((e) => {
      ...
      return P(
        ((e) => V(P(e, XA), KA))(t).concat(((e) => V(P(e, GA), JA))(t)),
        QA,
      )
    },
    eM = "tinymce-url-history",
    tM = (e) => r(e) && /^https?/.test(e),
    oM = (e) =>
      a(e) &&
      pe(e, (e) => {
        return !(l((t = e)) && t.length <= 5 && Y(t, tM))
        var t
      }).isNone(),
    nM = () => {
      const e = yS.getItem(eM)
      if (null === e) return {}
      let t
      try {
        t = JSON.parse(e)
        ...
        if (e instanceof SyntaxError)
          return (
            console.log("Local storage " + eM + " was not valid JSON", e), {}
          )
        throw e
      }
      return oM(t)
        ? t
        : (console.log("Local storage " + eM + " was not valid format", t), {})
    },
    sM = (e) => {
      const t = nM()
      return fe(t, e).getOr([])
    ...
    rM = (e, t) => {
      ...
      ;(o[t] = [e].concat(s).slice(0, 5)),
        ((e) => {
          ...
          yS.setItem(eM, JSON.stringify(e))
        })(o)
    },
    aM = (e) => !!e,
    iM = (e) => le(L_.makeMap(e, /[, ]/), aM),
    lM = (e) => A.from(Kf(e)),
    cM = (e) => A.from(e).filter(r).getOrUndefined(),
    dM = (e) => ({
      getHistory: sM,
      addToHistory: rM,
      getLinkInformation: () =>
      ...
      getUrlPicker: (t) =>
        ((e, t) =>
          ((e, t) => {
            const o = ((e) => {
              const t = A.from(Zf(e)).filter(aM).map(iM)
              return lM(e).fold(T, (e) =>
                t.fold(E, (e) => re(e).length > 0 && e),
              )
            })(e)
            return d(o) ? (o ? lM(e) : A.none()) : o[t] ? lM(e) : A.none()
          })(e, t).map(
            (o) => (n) =>
              hC((s) => {
                const i = {
    ...
    bM = y([rs("dom"), ws("shell", !0), $u("toolbarBehaviours", [_h])]),
    vM = y([
      ym({
        name: "groups",
        overrides: () => ({ behaviours: ca([_h.config({})]) }),
  ...
  const OM = y(Di("toolbar-height-change")),
    _M = {
      fadeInClass: "tox-editor-dock-fadein",
      fadeOutClass: "tox-editor-dock-fadeout",
      transitionClass: "tox-editor-dock-transition",
    },
    TM = "tox-tinymce--toolbar-sticky-on",
    EM = "tox-tinymce--toolbar-sticky-off",
    AM = (e, t) => F(Oi.getModes(e), t),
    MM = (e) => {
      const t = e.element
      at(t).each((o) => {
    ...
    DM = (e, t) => {
      t
        ? (Sa(e, _M.fadeOutClass), ka(e, [_M.transitionClass, _M.fadeInClass]))
        : (Sa(e, _M.fadeInClass), ka(e, [_M.fadeOutClass, _M.transitionClass]))
    },
    BM = (e, t) => {
      const o = ze(e.getContainer())
      t ? (ya(o, TM), Sa(o, EM)) : (ya(o, EM), Sa(o, TM))
    },
    IM = (e, t) => {
      const o = nn(),
        n = t.getSink,
        ...
        a = e.inline
          ? []
          : [dc.config({ channels: { [OM()]: { onReceive: MM } } })]
      return [
        Bh.config({}),
        Oi.config({
          contextual: {
            ...
            onShown: (e) => {
              s((e) => Oa(e, [_M.transitionClass, _M.fadeInClass])),
                o.get().each((t) => {
                  ;((e, t) => {
                    const o = tt(t)
                    hc(o)
  ...
  const RM = Fn(
      [Zx, as("items", Nn([Vn([ey, ms("items", Un)]), Un]))].concat(My),
    ),
    NM = [
      fs("text"),
      fs("tooltip"),
          ...
          const n = V(o, (e) => {
            const o = {
              ...
              n = VM(o)
                .mapError((e) => Zn(e))
                .getOrDie()
            return nE(n, "tox-mbtn", t.backstage, A.some("menuitem"))
          })
          _h.set(e, n)
        },
      }
                    ...
                    e
                      ...
                      .each((o) => {
                        e.getSystem()
                          .getByDom(t)
                          .each((e) => {
                            MC.expand(e), MC.close(o), Bh.focus(e)
                          })
                      })
                })
              })
              ...
              t.event.prevFocus
                ...
                .each((o) => {
                  t.event.newFocus
                    .bind((t) => e.getSystem().getByDom(t).toOptional())
                    .each((e) => {
                      MC.isOpen(o) && (MC.expand(e), MC.close(o))
                    })
                })
            }),
          ]),
  ...
  const PM = "container",
    ...
    $M = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = []
            return {
              slot: (t, o) => (e.push(t), Tm(PM, WM(t), o)),
              record: y(e),
            }
          })(),
          o = e(t),
          n = t.record(),
          s = V(n, (e) => vm({ name: e, pname: WM(e) }))
        return Um(PM, UM, s, jM, o)
      },
    },
    GM = Fn([py, hy, Ts("onShow", b), Ts("onHide", b), dy]),
    qM = (e) => ({ element: () => e.element.dom }),
    YM = (e, t) => {
      const o = V(re(t), (e) => {
        const o = t[e],
          n = Jn(((e) => Kn("sidebar", GM, e))(o))
        return {
          name: e,
          getApi: qM,
          onSetup: n.onSetup,
    ...
    XM = (e) =>
      $M.sketch((t) => ({
        ...
        components: YM(t, e),
        slotBehaviours: uw([Jr((e) => $M.hideAllSlots(e))]),
      })),
    KM = (e, t) => {
      St(e, "role", t)
    },
    JM = (e) =>
      Jm.getCurrent(e).bind((e) =>
        tE.isGrowing(e) || tE.hasGrown(e)
          ? Jm.getCurrent(e).bind((e) =>
              j($M.getSlotNames(e), (t) => $M.isShowing(e, t)),
            )
          : A.none(),
      ),
    QM = Di("FixSizeEvent"),
  ...
  const oD = ua({
    ...
    nD = (e) => Jm.getCurrent(e).each((e) => mc(e.element, !0)),
    sD = (e, t, o) => {
      const n = en(!1),
        s = nn(),
        r = (o) => {
          ...
          n.get() &&
            ...
            (o.preventDefault(), nD(t()), e.editorManager.setActive(e))
        }
      e.inline ||
        e.on("PreInit", () => {
    ...
    rD = (e, t, o) => ({ within: e, extra: t, withinWidth: o }),
    aD = (e, t, o) => {
      const n = W(
          e,
          (e, t) =>
    ...
    cD = (e, t, o) => {
      ...
      const s = Im(e, t, "primary"),
        r = dC.getCoupled(e, "overflowGroup")
      ...
      const l = ((e, t, o, n) => {
        const s = ((e, t, o) => {
          ...
          })(e, t, o).getOrThunk(() => aD(t, e - o(n), o)),
          r = s.within,
          a = s.extra,
          i = s.withinWidth
        return 1 === a.length && a[0].width <= o(n)
          ? ((e, t, o) => {
              const n = iD(e.concat(t))
              return rD(n, [], o)
            })(r, a, i)
          : a.length >= 1
            ? ((e, t, o, n) => {
                const s = iD(e).concat([o])
                return rD(s, iD(t), n)
              })(r, a, n, i)
            : ((e, t, o) => rD(iD(e), [], o))(r, 0, i)
      })(
        Kt(s.element),
        t.builtGroups.get(),
      ...
      0 === l.extra.length
        ? (_h.remove(s, r), o([]))
        : (lD(s, l.within), o(l.extra)),
        Vt(s.element, "visibility"),
        Lt(s.element),
        i.each(Bh.focus)
    },
    dD = y([
      $u("splitToolbarBehaviours", [dC]),
      ns("builtGroups", () => en([])),
    ]),
    uD = y(
      [
    ...
    mD = y([
      vm({ factory: xM, schema: bM(), name: "primary" }),
      xm({ schema: bM(), name: "overflow" }),
    ...
    fD = nn(),
    bD = (e, t) => {
      const o = dC.getCoupled(e, "toolbarSandbox")
    ...
    xD = (e, t, o, n, s) => {
      xM.setGroups(t, s), vD(e, t, o, n), Hh.on(e)
    },
    yD = qm({
      ...
      factory: (e, t, o, n) => ({
                  ...
                  ((e, t, o) => {
                    ...
                    return {
                      ...
                      behaviours: ca([
                        ...
                        ku.config({
                          onOpen: (s, r) => {
                            const a = fD.get().getOr(!1)
                            o.fetch().get((s) => {
                              xD(e, r, o, t.layouts, s),
                                n.link(e.element),
                                a || bh.focusIn(r)
                            })
                          },
                        ...
                        dc.config({
                          channels: {
                            ...
                            ...Du({
                              doReposition: () => {
                                ku.getState(
                                  dC.getCoupled(e, "toolbarSandbox"),
                                ).each((n) => {
                                  vD(e, n, o, t.layouts)
                                })
                              },
        ...
        apis: {
          setGroups: (t, n) => {
            ku.getState(dC.getCoupled(t, "toolbarSandbox")).each((s) => {
              xD(t, s, e, o.layouts, n)
            })
          },
          reposition: (t) => {
            ku.getState(dC.getCoupled(t, "toolbarSandbox")).each((n) => {
              vD(t, n, e, o.layouts)
            })
          },
          toggle: (e) => {
          ...
          toggleWithoutFocusing: (e) => {
            ;((e, t) => {
              fD.set(!0), bD(e, t), fD.clear()
            })(e, n)
          },
          getToolbar: (e) => ku.getState(dC.getCoupled(e, "toolbarSandbox")),
          isOpen: (e) => ku.isOpen(dC.getCoupled(e, "toolbarSandbox")),
        },
      }),
      configFields: pD(),
      partFields: hD(),
    ...
    wD = y([rs("items"), hi(["itemSelector"]), $u("tgroupBehaviours", [bh])]),
    SD = y([wm({ name: "items", unit: "item" })]),
    CD = qm({
      name: "ToolbarGroup",
      configFields: wD(),
      partFields: SD(),
        ...
        return {
          ...
          behaviours: qu(e.splitToolbarBehaviours, [
            dC.config({
              others: {
                overflowGroup: () =>
                  CD.sketch({ ...n["overflow-group"](), items: [s.asSpec()] }),
              },
            }),
          ]),
          apis: {
            setGroups: (t, o) => {
              e.builtGroups.set(V(o, t.getSystem().build)), OD(t, s, e)
            },
            refresh: (t) => OD(t, s, e),
            toggle: (e) => {
              s.getOpt(e).each((e) => {
            ...
            toggleWithoutFocusing: (e) => {
              s.getOpt(e).each(yD.toggleWithoutFocusing)
            },
            isOpen: (e) => s.getOpt(e).map(yD.isOpen).getOr(!1),
            reposition: (e) => {
              s.getOpt(e).each((e) => {
                yD.reposition(e)
              })
            },
            getOverflow: (e) => s.getOpt(e).bind(yD.getToolbar),
          },
          domModification: { attributes: { role: "group" } },
        }
      },
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          apis: {
            ...
            isOpen: (t) =>
              ((e, t) => Bm(e, t, "overflow").map(tE.hasGrown).getOr(!1))(t, e),
          },
          domModification: { attributes: { role: "group" } },
        }
      },
    ...
    BD = (e) => {
      ...
      return {
        ...
        tgroupBehaviours: ca([Pb.config({}), Bh.config({})]),
      }
    },
    ID = (e) => CD.sketch(BD(e)),
    FD = (e, t) => {
      const o = Jr((t) => {
        const o = V(e.initGroups, ID)
        xM.setGroups(t, o)
      })
      return ca([
        hw(() => e.providers.checkUiComponentContext("any").shouldDisable),
        Ow(() => e.providers.checkUiComponentContext("any")),
        bh.config({
          mode: t,
          onEscape: e.onEscape,
    ...
    RD = (e) => {
      ...
      return {
        ...
        parts: {
          "overflow-group": BD({ title: A.none(), label: A.none(), items: [] }),
          "overflow-button": DE(
            {
              context: "any",
              name: "more",
    ...
    HD = {
      button: [...LD, oy, ls("type", ["button"])],
      togglebutton: [...LD, _s("active", !1), ls("type", ["togglebutton"])],
    },
    PD = [ls("type", ["group"]), Es("buttons", [], es("type", HD))],
    UD = es("type", { ...HD, group: PD }),
    WD = Fn([Es("buttons", [], UD), cs("onShow"), cs("onHide")]),
    jD = (e, t) =>
      ((e, t) => {
        var o, n
        const s = "togglebutton" === e.type,
          r = e.icon.map((e) => bT(e, t.icons)).map(Vb),
          a = {
            ...e,
            name: s
          ...
          i = BE(null !== (n = e.buttonType) && void 0 !== n ? n : "secondary"),
  ...
  var YD = qm({
    ...
    partFields: [
              ...
              "group" === o.type
                ? ((t = !0),
                  ((e, t) => ({
                    ...
                    components: V(e.buttons, (e) => jD(e, t)),
                  }))(o, e.providers))
                : jD(o, e.providers),
            )
            return {
      ...
      ym({
        factory: {
          sketch: (e) => ({
            uid: e.uid,
            behaviours: ca([Bh.config({}), Pb.config({})]),
    ...
    factory: (e, t, o, n) => {
      ...
      return {
        ...
        behaviours: ca([
          Bh.config({}),
          bh.config({ mode: "cyclic", focusInside: jg.OnEnterOrSpaceMode }),
        ]),
        apis: s,
      }
    },
  ...
  const XD = (e, t, o) =>
      ge(t, (t, n) => {
        ...
        return e.slot(
          ...
          YD.sketch({
            ...
            components: [
              ...(s.buttons.length > 0
                ? [YD.parts.header({ buttons: s.buttons, providers: o })]
                : []),
              YD.parts.pane({}),
            ],
          }),
    ...
    JD = (e) => j($M.getSlotNames(e), (t) => $M.isShowing(e, t)),
    QD = (e, t, o) => {
      $M.getSlot(e, t).each((e) => {
        YD.getPane(e).each((t) => {
          var n
  ...
  var ZD = Gm({
    factory: (e, t) => {
      const o = {
        setViews: (e, o) => {
          _h.set(e, [KD(o, t.backstage.shared.providers)])
        },
        whichView: (e) => Jm.getCurrent(e).bind(JD),
        toggleView: (e, t, o, n) =>
          Jm.getCurrent(e).exists((s) => {
            const r = JD(s),
              a = r.exists((e) => n === e),
              i = $M.getSlot(s, n).isSome()
            return (
              i &&
                ($M.hideAllSlots(s),
                a
                ...
                r.each((e) => ((e, t) => QD(e, t, YD.getOnHide))(s, e))),
              i
            )
          }),
      }
  ...
  const eB = mM.optional({
    ...
    oB = mM.optional({
      factory: {
        sketch: (e) => {
          const t = ((e) =>
            e.type === xf.sliding ? zD : e.type === xf.floating ? ND : VD)(e)
          return t({
            type: e.type,
            uid: e.uid,
            onEscape: () => (e.onEscape(), A.some(!0)),
    ...
    rB = mM.optional({ name: "socket", schema: [rs("dom")] }),
    aB = mM.optional({
      factory: {
        sketch: (e) => ({
          uid: e.uid,
          ...
          components: [
            {
              ...
              behaviours: ca([
                ...
                tE.config({
                  ...
                  onShrunk: (e) => {
                    Jm.getCurrent(e).each($M.hideAllSlots), Fr(e, ZM)
                  },
                  onGrown: (e) => {
                    Fr(e, ZM)
                  },
                  onStartGrow: (e) => {
                    Rr(e, QM, { width: Rt(e.element, "width").getOr("") })
                  },
                  onStartShrink: (e) => {
                    Rr(e, QM, { width: Kt(e.element) + "px" })
                  },
                }),
                _h.config({}),
                Jm.config({
  ...
  var dB = qm({
    ...
    factory: (e, t, o) => {
      ...
      const s = (e) => {
        ...
        a = {
          getSocket: (t) => uM.getPart(t, e, "socket"),
          setSidebar: (t, o, n) => {
            uM.getPart(t, e, "sidebar").each((e) =>
              ((e, t, o) => {
              ...
              ((e, t) => {
                Jm.getCurrent(e).each((o) => {
                  Jm.getCurrent(o).each((n) => {
                    tE.hasGrown(o)
                      ? $M.isShowing(n, t)
                        ? (tE.shrink(o), KM(e.element, "presentation"))
                        : ($M.hideAllSlots(n),
                          $M.showSlot(n, t),
                          KM(e.element, "region"))
                      : ($M.hideAllSlots(n),
          ...
          whichSidebar: (t) => uM.getPart(t, e, "sidebar").bind(JM).getOrNull(),
          getHeader: (t) => uM.getPart(t, e, "header"),
          getToolbar: (t) => uM.getPart(t, e, "toolbar"),
          setToolbar: (t, o) => {
            uM.getPart(t, e, "toolbar").each((e) => {
              const t = V(o, ID)
              e.getApis().setGroups(e, t)
            })
          },
          setToolbars: (t, o) => {
            uM.getPart(t, e, "multiple-toolbar").each((e) => {
              const t = V(o, (e) => V(e, ID))
              fM.setItems(e, t)
            })
          },
          refreshToolbar: (t) => {
            uM.getPart(t, e, "toolbar").each((e) => e.getApis().refresh(e))
          },
          ...
          isToolbarDrawerToggled: (t) =>
            uM
              ...
              .getOr(!1),
          getThrobber: (t) => uM.getPart(t, e, "throbber"),
          focusToolbar: (t) => {
            uM.getPart(t, e, "toolbar")
              .orThunk(() => uM.getPart(t, e, "multiple-toolbar"))
              .each((e) => {
                bh.focusIn(e)
              })
          },
          setMenubar: (t, o) => {
            uM.getPart(t, e, "menubar").each((e) => {
              HM.setMenus(e, o)
            })
          },
          focusMenubar: (t) => {
          ...
          setViews: (t, o) => {
            uM.getPart(t, e, "viewWrapper").each((e) => {
              ZD.setViews(e, o)
            })
          },
          toggleView: (t, o) =>
            uM.getPart(t, e, "viewWrapper").exists((e) =>
              ZD.toggleView(
                e,
                () => a.showMainView(t),
                () => a.hideMainView(t),
          ...
          whichView: (t) =>
            uM.getPart(t, e, "viewWrapper").bind(ZD.whichView).getOrNull(),
          hideMainView: (t) => {
            ;(n = a.isToolbarDrawerToggled(t)),
              n && a.toggleToolbarDrawer(t),
              uM.getPart(t, e, "editorContainer").each((e) => {
                const t = e.element
    ...
    partFields: [nB, eB, oB, tB, rB, aB, sB, iB, lB, cB],
    apis: {
  ...
  const uB = {
      ...
      const o = { ...uB, ...t.menus },
        ...
        s =
          void 0 === t.menubar || !0 === t.menubar
            ? mB("file edit view insert format tools table help")
            : mB(!1 === t.menubar ? "" : t.menubar),
        a = P(s, (e) => {
          const o = be(uB, e)
        ...
        i = V(a, (n) => {
          ...
          })({ title: s.title, items: mB(s.items) }, t, e)
        })
      return P(
        i,
        (e) =>
    ...
    pB = (e, t, o) => (e.on("remove", () => o.unload(t)), o.load(t)),
    hB = (e, t, o, n) => (
      e.on("remove", () => n.unloadRawCss(t)), n.loadRawCss(t, o)
    ),
    fB = (e) => A.from(tinymce.Resource.get(e)).filter(r),
    bB = (e, t, o = "") => {
      const n = ((e) => {
          const t = gb(e)
    ...
    vB = (e, t) => {
      ...
      switch (n._kind) {
        case "load-raw":
          const { key: t, css: s } = n
          return hB(e, t, s, o), Promise.resolve()
    ...
    xB = (e, t) => {
      ...
      {
        const o = Sf.DOM.styleSheetLoader,
          n = bB(e, "skin.shadowdom", t)
        switch (n._kind) {
          case "load-raw":
            const { key: t, css: s } = n
            return hB(e, t, s, o), Promise.resolve()
    ...
    yB = (e, t) =>
      (async (e, t) => {
        ...
        if (
          (await ((e, t, o) => {
            const n = bB(e, t ? "content.inline" : "content", o)
            switch (n._kind) {
              case "load-raw":
                const { key: s, css: r } = n
                return (
                  t
                    ? hB(e, s, r, e.ui.styleSheetLoader)
                    : e.on("PostRender", () => {
                        hB(e, s, r, e.dom.styleSheetLoader)
                      }),
                  Promise.resolve()
                )
              case "load-stylesheet":
          ...
          return Promise.all([vB(t, o), xB(t, o)]).then()
      })(e, t).then(
        ((e) => {
          const t = () => {
            ;(e._skinLoaded = !0),
    ...
    OB = (e, t) => {
      const o = t.dataset,
        n =
          "basic" === o.type
            ? () => V(o.data, (e) => zA(e, t.isSelectedFor, t.getPreviewFor))
            : o.getData
      return { items: kB(e, t), getStyleItems: n }
    },
    _B = (e, t, o, n, s, r) => {
      const { items: a, getStyleItems: i } = OB(t, o),
        l = en(o.tooltip)
      return wT(
        {
          context: "mode:design",
          ...
          onSetup: (t) => {
            const r = (o) => t.setTooltip(CB(e, n(o.value), o.value))
            return (
              e.on(s, r),
              pS(
                bS(e, "NodeChange", (t) => {
  ...
  const EB = (e, t, o) => {
      const n =
        ((s = ((e, t) =>
          t === TB.SemiColon ? e.replace(/;$/, "").split(";") : e.split(" "))(
          e.options.get(t),
          o,
        )),
        V(s, (e) => {
    ...
    BB = (e) => {
      ...
      return {
        ...
        onAction: (t) => () =>
          j(DB, (e) => e.format === t.format).each((t) =>
            e.execCommand(t.command),
          ),
        updateText: (t) => {
          const o = j(DB, (t) => e.formatter.match(t.format)).fold(y(MB), (e) =>
            e.title.toLowerCase(),
          )
          Rr(t, yT, { icon: `align-${o}` }),
            ((e, t) => {
    ...
    RB = "Paragraph",
    NB = (e) => {
      const t = EB(e, "block_formats", TB.SemiColon)
      return {
        tooltip: CB(e, FB(), RB),
        text: A.some(RB),
        icon: A.none(),
        ...
        onAction: vS(e),
        updateText: (o) => {
          const n = IB(e, () => t.data).fold(y(RB), (e) => e.title)
          Rr(o, xT, { text: n }),
            ((e, t) => {
    ...
    PB = (e, t) => t.length > 0 && Y(t, (t) => e.indexOf(t.toLowerCase()) > -1),
    UB = (e) => {
      const t = () => {
          const t = (e) => (e ? HB(e)[0] : ""),
              ...
              Ce(
                ((e, t) => {
                  if (0 === e.indexOf("-apple-system") || t.length > 0) {
                    const o = HB(e.toLowerCase())
                    return PB(o, LB) || PB(o, t)
                  }
                  return !1
                })(r, a),
                { title: VB, format: r },
        ...
        o = EB(e, "font_family_formats", TB.SemiColon)
      return {
        tooltip: CB(e, zB(), VB),
        text: A.some(VB),
        icon: A.none(),
    ...
    $B = (e, t) =>
      A.from(jB.exec(e)).bind((e) => {
        const o = Number(e[1]),
          n = e[2]
        return ((e, t) => R(t, (t) => R(WB[t], (t) => e === t)))(n, t)
    ...
    ZB = (e) => {
      const t = () => {
        ...
        o = y(A.none),
        n = EB(e, "font_size_formats", TB.Space)
      return {
        tooltip: CB(e, qB(), YB),
        text: A.some(YB),
        icon: A.none(),
          ...
          const n = (e) =>
              BA(e)
                ...
                : IA(e)
                  ...
                  : [],
            s = q(NA(e), n),
            r = IB(e, y(s)).fold(y({ title: o, tooltipLabel: "" }), (e) => ({
              title: e.title,
              tooltipLabel: e.title,
            }))
          Rr(t, xT, { text: r.title }),
            ((e, t) => {
    ...
    oI = y(
      [
        ...
        rs("dom"),
        bi("onOpen"),
        $u("splitDropdownBehaviours", [dC, bh, Bh]),
        ws("matchWidth", !1),
        ws("useMinWidth", !1),
        ws("eventOrder", {}),
        gs("role"),
    ...
    aI = qm({
      ...
      factory: (e, t, o, n) => {
        const s = (e) => {
          ...
          r = (t) => {
            SC(e, w, t, n, s, hf.HighlightMenuAndItem).get(b)
          },
          a = (t) => {
    ...
    cI = (e, t) => e.map((e) => ({ "aria-label": t.translate(e) })).getOr({}),
    dI = Di("focus-button"),
    uI = (e, t, o, n, s, r, a) => {
      const i = t.map((e) => Vb(vT(e, "tox-tbtn", s))),
        l = e.map((e) => Vb(bT(e, s.icons)))
      return {
        dom: {
          tag: "button",
          classes: ["tox-tbtn"].concat(t.isSome() ? ["tox-tbtn--select"] : []),
          attributes: { ...cI(o, s), ...(g(a) ? { "data-mce-name": a } : {}) },
        },
        components: Ew([l.map((e) => e.asSpec()), i.map((e) => e.asSpec())]),
        eventOrder: {
          [js()]: ["focusing", "alloy.base.behaviour", mT],
          [Cr()]: [mT, "toolbar-group-button-events"],
          [kr()]: [mT, "toolbar-group-button-events", "tooltipping"],
        },
        buttonBehaviours: ca(
          [
            hw(() => s.checkUiComponentContext(r).shouldDisable),
            Ow(() => s.checkUiComponentContext(r)),
            Th(mT, [
              Jr((e, t) => pT(e)),
              Wr(xT, (e, t) => {
              ...
              Wr(yT, (e, t) => {
                l.bind((t) => t.getOpt(e)).each((e) => {
                  _h.set(e, [bT(t.event.icon, s.icons)])
                })
              }),
              Wr(js(), (e, t) => {
                t.event.prevent(), Fr(e, dI)
              }),
            ]),
          ].concat(n.getOr([])),
        ),
    ...
    mI = (e, t, o, n) => {
      var s
      const r = en(b),
        a = uI(e.icon, e.text, e.tooltip, A.none(), o, e.context, n)
      return Nb.sketch({
        dom: a.dom,
        ...
        buttonBehaviours: {
          ...ca(
            [
              Th("toolbar-button-events", [
                ...
                ea((e, t) => {
                  fw(
                    ...
                    Rr(e, uT, { buttonApi: t }), i.onAction(t)
                  })
                })),
                bw(t, r),
                vw(t, r),
              ...
              Ow(() => o.checkUiComponentContext(e.context)),
            ].concat(t.toolbarButtonBehaviours),
          ),
          [mT]:
            null === (s = a.buttonBehaviours) || void 0 === s ? void 0 : s[mT],
        },
      })
      var i
    },
        ...
        A.from(
          VC(
            xn(
              ...
              {
                movement: ZS(t.columns, t.presets),
                menuBehaviours: uw(
                  "auto" !== t.columns
                    ? []
                    : [
                        Jr((e, o) => {
                          dw(e, 4, kx(t.presets)).each(
    ...
    vI = {
      button: bI(By, (e, t, o, n) =>
        ((e, t, o) => gI(e, t, [], o))(e, t.shared.providers, n),
      ),
      togglebutton: bI(Ry, (e, t, o, n) =>
        ((e, t, o) => pI(e, t, [], o))(e, t.shared.providers, n),
      ),
      menubutton: bI(VM, (e, t, o, n) => nE(e, "tox-tbtn", t, A.none(), !1, n)),
      splitbutton: bI(
        (e) => Kn("SplitButton", LM, e),
        (e, t, o, n) =>
          ((e, t, o) => {
            ...
            return aI.sketch({
              ...
              toggleClass: "tox-tbtn--enabled",
              lazySink: t.getSink,
              fetch: hI(s, e, t.providers),
              parts: { menu: Mx(0, e.columns, e.presets) },
              components: [
                aI.parts.button(
                  uI(
                    e.icon,
                    ...
                    A.some([
                      ...
                      hw(T),
                      Ow(y({ contextType: "any", shouldDisable: !1 })),
                    ]),
                    t.providers,
                    e.context,
                  ),
                ...
                aI.parts.arrow({
                  dom: {
                    ...
                    innerHtml: sx("chevron-down", t.providers.icons),
                  },
                  buttonBehaviours: ca([
                    pw(T),
                    Ow(y({ contextType: "any", shouldDisable: !1 })),
      ...
      grouptoolbarbutton: bI(
        (e) => Kn("GroupToolbarButton", RM, e),
        (e, t, o, n) => {
          ...
          if (Pf(o) === xf.floating)
            return ((e, t, o, n, s) => {
              const r = t.shared,
                ...
                l = [
                  Th("toolbar-group-button-events", [bw(i, a), vw(i, a)]),
                  ...e.tooltip
                    .map((e) =>
                      Qb.config(
                        t.shared.providers.tooltips.getConfig({
    ...
    xI = {
      styles: (e, t) => {
        ...
        return _B(e, t, tI(e, o), eI, "StylesTextUpdate", "styles")
      },
      fontsize: (e, t) => _B(e, t, ZB(e), qB, "FontSizeTextUpdate", "fontsize"),
      fontsizeinput: (e, t) =>
        ((e, t, o, n) => {
          let s = A.none()
          const r = bS(e, "NodeChange SwitchMode DisabledStateChange", (t) => {
              const n = t.getComponent()
              ;(s = A.some(n)),
                o.updateInputValue(n),
                ug.set(n, !e.selection.isEditable() || Af(e))
            }),
            ...
            h = (o, n, s, r) => {
              const i = en(b),
                ...
                c = Di("altExecuting"),
                d = bS(e, "NodeChange SwitchMode DisabledStateChange", (t) => {
                  ug.set(t.getComponent(), !e.selection.isEditable() || Af(e))
                }),
                u = (e) => {
                  ug.isDisabled(e) || o(!0)
                }
              return Nb.sketch({
                ...
                components: [fT(n, t.shared.providers.icons)],
                buttonBehaviours: ca([
                  ug.config({}),
                  Qb.config(
                  ...
                  Th(c, [
                    bw({ onSetup: d, getApi: a }, i),
                    vw({ getApi: a }, i),
                    Wr(Js(), (e, t) => {
                      ;(t.event.raw.keyCode !== GB.space() &&
                        t.event.raw.keyCode !== GB.enter()) ||
                        ug.isDisabled(e) ||
                        o(!1)
                    }),
                    Wr(tr(), u),
          ...
          ((e) => {
            ...
            return {
              updateInputValue: (e) => Rr(e, xT, { text: t() }),
              onAction: (t, o) =>
                e.execCommand("FontSize", !1, t, { skip_focus: !o }),
              getNewValue: (o, n) => {
                $B(o, ["unsupportedLength", "empty"])
                const s = t(),
                  r = $B(o, ["unsupportedLength", "empty"]).or(
                    $B(s, ["unsupportedLength", "empty"]),
                  ),
      ...
      fontfamily: (e, t) =>
        _B(e, t, UB(e), zB, "FontFamilyTextUpdate", "fontfamily"),
      blocks: (e, t) => _B(e, t, NB(e), FB, "BlocksTextUpdate", "blocks"),
      align: (e, t) => _B(e, t, BB(e), AB, "AlignTextUpdate", "align"),
    },
    yI = (e, t, o, n) => {
      const s = ((e) => {
          const t = e.toolbar,
          ...
          return !1 === t
            ...
            : void 0 === t || !0 === t
              ? ((e) => {
                  const t = V(fI, (t) => {
                    const o = P(t.items, (t) => be(e, t) || be(xI, t))
            ...
            0 === s.trim().length
              ...
              : ((e, t, o, n, s, r) =>
                  fe(t, o.toLowerCase())
                    ...
                    .fold(
                      () => fe(xI, o.toLowerCase()).map((t) => t(e, s)),
                      (t) =>
    ...
    wI = (e, t, o, n) => {
      ...
      if (f(a, r)) {
        const t = a.map((t) => {
          ...
          return yI(e, s, n, A.none())
        })
        dB.setToolbars(s, t)
      } else dB.setToolbar(s, yI(e, o, n, A.none()))
    },
    SI = Mo(),
    CI = SI.os.isiOS() && SI.os.version.major <= 12
  var kI = Object.freeze({
    ...
    render: (e, t, o, n, s) => {
      ...
      uu(d, r.mothership),
        ((e, t, o) => {
          Tb(e) && uu(o.mainUi.mothership.element, o.popupUi.mothership),
            du(t, o.dialogUi.mothership)
        })(e, u, t),
        e.on("PostRender", () => {
          dB.setSidebar(l, o.sidebar, cb(e))
        }),
        e.on("SkinLoaded", () => {
          wI(e, t, o, n),
            i.set(e.getWin().innerWidth),
            dB.setMenubar(l, gB(e, o)),
            dB.setViews(l, o.views),
            ((e, t) => {
              ...
              const r = e.getDoc().documentElement,
                ...
                l = () => {
                  ...
                  ;(t.left === s.innerWidth && t.top === s.innerHeight) ||
                    (a.set($t(s.innerWidth, s.innerHeight)), dS(e))
                },
                c = () => {
                  const t = e.getDoc().documentElement,
                    o = i.get()
                  ;(o.left === t.offsetWidth && o.top === t.offsetHeight) ||
                    (i.set($t(t.offsetWidth, t.offsetHeight)), dS(e))
                },
                d = (t) => {
                  ;((e, t) => {
      ...
      kw(e, t),
        ...
        e.addQueryValueHandler("ToggleSidebar", () => {
          var e
          return null !== (e = dB.whichSidebar(l)) && void 0 !== e ? e : ""
        }),
        e.addCommand("ToggleView", (t, o) => {
          if (dB.toggleView(l, o)) {
            const t = l.element
            r.mothership.broadcastOn([Ou()], { target: t }),
              ...
              c(dB.whichView(l)) &&
                (e.focus(), e.nodeChanged(), dB.refreshToolbar(l)),
              ((e) => {
        ...
        e.addQueryValueHandler("ToggleView", () => {
          var e
          return null !== (e = dB.whichView(l)) && void 0 !== e ? e : ""
        })
      const g = Pf(e)
      ;(g !== xf.sliding && g !== xf.floating) ||
        e.on("ResizeWindow ResizeEditor ResizeContent", () => {
          ...
          o !== i.get() &&
            (dB.refreshToolbar(t.mainUi.outerContainer), i.set(o))
        })
      const p = {
        setEnabled: (e) => {
          Cw(t, e ? "setEnabled" : "setDisabled")
        },
  ...
  const OI = (e) =>
    ...
    EI = (e) => {
      const t = Df(e),
        o = Bf(e),
        n = Ff(e)
      return OI(t).map((e) => TI(e, o, n))
    },
    { ToolbarLocation: AI, ToolbarMode: MI } = Ab,
    DI = (e, t, o, n, s) => {
      const { mainUi: r, uiMotherships: a } = o,
        ...
        x = (o) => {
          ...
          if ((p && dB.refreshToolbar(r.outerContainer), !l)) {
            const o = Po(),
              i = Ce(n.left !== o.left, n)
            ;((o, n) => {
              s.on((s) => {
                const a = dB.getToolbar(r.outerContainer),
                  i = b(a),
                  l = Ko(t),
                  c = ((e, t) => (Tb(e) ? Aa(t) : A.none()))(
                    e,
          ...
          s.get().exists((o) => {
            const n = u.getDockingMode(),
              a = ((o) => {
                switch (Wf(e)) {
                  case AI.auto:
                    const e = dB.getToolbar(r.outerContainer),
                      n = b(e),
                      s = Ut(o.element) - n,
                      a = Ko(t)
                    if (a.y > s) return "top"
  ...
  var II = Object.freeze({
    ...
    render: (e, t, o, n, s) => {
      ...
      const d = () => {
        ...
        a.set(dB.getHeader(r.outerContainer).getOrDie())
        const s = kb(e)
        Tb(e)
        ...
        const d = () => {
          wI(e, t, o, n),
            dB.setMenubar(r.outerContainer, gB(e, o)),
            l.show(),
            ((e, t, o, n) => {
              const s = en(BI(t, o.isPositionedAtTop())),
                r = (n) => {
                  const { pos: r, bounds: a } = BI(t, o.isPositionedAtTop()),
              ...
              let a = 0
              const i = U_(() => o.update(Oi.refresh), 33)
              e.on("ScrollWindow", () => {
                const e = Po().left
  ...
  const FI = "contexttoolbar-hide",
    ...
    zI = Di("forward-slide"),
    VI = Di("backward-slide"),
    LI = Di("change-slide-event"),
    HI = "tox-pop--resizing",
    PI = (e) => {
      const t = nn()
      return {
        ...
        hide: () => {
          t.isSet() || t.set(ju.getValue(e)), Fr(e, fr())
        },
        back: () => {
          t.isSet() || t.set(ju.getValue(e)), Fr(e, VI)
        },
        getValue: () => t.get().getOrThunk(() => ju.getValue(e)),
        setValue: (o) => {
          t.isSet() ? t.set(o) : ju.setValue(e, o)
        },
      }
    },
    UI = (e, t) =>
            ...
            ((e) => "contextformtogglebutton" === e.type)(t)
              ? ((e, t, o) => {
                  const { primary: n, ...s } = t.original,
                    r = Jn(Ry({ ...s, type: "togglebutton", onAction: b }))
                  return pI(r, o, [UI(e, t)])
                })(e, t, o)
              : ((e, t, o) => {
                  const { primary: n, ...s } = t.original,
                    r = Jn(By({ ...s, type: "button", onAction: b }))
                  return gI(r, o, [UI(e, t)])
                })(e, t, o))(e, t, o),
        ),
      )
      return {
      ...
      return VT(
        {
          ...
          height: s,
          onEnter: A.some(o),
          onInput: A.some((t) => e.onInput(PI(t))),
          onSetup: A.some(e.onSetup),
          getApi: A.some(PI),
        },
        t,
      )
      ...
      tk.sketch({
        ...
        fieldBehaviours: ca([
          ug.config({
            ...
            onDisabled: (e) => {
              NI(e), tk.getField(e).each(ug.disable)
            },
            onEnabled: (e) => {
              tk.getField(e).each(ug.enable)
            },
      ...
      const n = en(b),
        ...
        r = tk.parts.field({
          ...
          inputBehaviours: ca([
            ...
            Th("slider-events", [
              bw(
                { onSetup: e.onSetup, getApi: PI, onBeforeSetup: bh.focusIn },
                n,
              ),
              vw({ getApi: PI }, n),
              Wr(Zs(), (t) => {
    ...
    XI = (e, t) => {
      switch (e.type) {
        case "contextform":
          return YI(C(qI, e), e, t)
        case "contextsliderform":
          return YI(C(GI, e), e, t)
        case "contextsizeinputform":
          return YI(C(jI, e), e, t)
      }
    },
    ...
    eF = { maxHeightFunction: Lc(), maxWidthFunction: gD() },
    tF = (e) => "node" === e,
    oF = (e, t, o, n, s) => {
      const r = JI(e),
      ...
      return ((e, t) => {
        ...
        : a
          ? ((e, o, s) => {
              ...
              Mt(e, "position", o)
              const i = KI(r, Ko(t), -20) && !n.isReposition() ? xA : bA
        ...
        L(i, (i) => {
          ...
          "contextsizeinputform" === l.type
            ...
            : "contexttoolbar" === l.type &&
              ((e, t) => {
                var o
                ;((o = t), Kn("ContextToolbar", Gy, o)).each((o) => {
      ...
      const s = n.backstage,
        ...
        u = pl(
          ((e) => {
                ...
                Th("context-toolbar-events", [
                  Kr(nr(), (e, t) => {
                    "width" === t.event.raw.propertyName &&
                      (Sa(e.element, HI), Vt(e.element, "width"))
                  }),
                  Wr(LI, (e, t) => {
                    const o = e.element
                    Vt(o, "width")
                    ...
                    Vt(o, "left"),
                      Vt(o, "right"),
                      Vt(o, "max-width"),
                      vf.setContent(e, t.event.contents),
                      ya(o, HI)
                    const s = Kt(o)
                    ...
                    e.onBack(),
                      oe(t.get()).each((e) => {
                        t.set(t.get().slice(0, t.get().length - 1)),
                          Rr(o, LI, { contents: hl(e.bar), focus: e.focus })
                      })
                  }),
                ]),
                bh.config({
            ...
            sink: o,
            onEscape: () => (e.focus(), gS(e), A.some(!0)),
            onHide: () => {
              gS(e)
            },
            onBack: () => {
              ...
              o = xe(d.get(), "node")
                ? ((e, t) =>
                    t
                      .filter((e) => vt(e) && je(e))
                      .map(Jo)
                      .getOrThunk(() => JI(e)))(e, l.get())
                : JI(e)
            return t.height <= 0 || !KI(o, t, 0.01)
          }
          return !0
        },
        h = () => {
          l.clear(), c.clear(), d.clear(), vf.hide(u)
        },
        f = () => {
          if (vf.isOpen(u)) {
            const e = u.element
            Vt(e, "display"),
              p() ? Mt(e, "display", "none") : (c.set(0), vf.reposition(u))
          }
        },
        v = (t) => ({
        ...
        x = Qt(() =>
          rF(t, (e) => {
            const t = y([e])
            Rr(u, zI, { forwardContents: v(t) })
          }),
        ),
        y = (t) => {
          const { buttons: o } = e.ui.registry.getAll(),
            s = { ...o, ...x().formNavigators },
            i = Pf(e) === xf.scrolling ? xf.scrolling : xf.default,
            l = G(
              V(t, (t) => {
                return "contexttoolbar" === t.type
                  ? ((t, o) =>
                      ...
                      s,
                      ((o = t),
                      { ...o, items: r(o.items) ? o.items : V(o.items, qy) }),
                    )
                  : ((e, t) => XI(e, t))(t, a.providers)
                var o
              }),
            )
          return VD({
        ...
        w = (t, n) => {
          ...
          Vt(f, "display"),
            ((e) => xe(we(e, l.get(), Ze), !0))(n) ||
              (Sa(f, aF), Qd.reset(o, u)),
            vf.showWithinBounds(
              u,
              v(s),
              { anchor: h, transition: { classes: [aF], mode: "placement" } },
              () => A.some(m()),
            ),
        ...
        e.on("remove", h),
          ...
          e.on("contexttoolbar-show", (t) => {
            ...
            fe(o.lookupTable, t.toolbarKey).each((o) => {
              w([o], Ce(t.target !== e, t.target)), RI(u)
            })
          }),
          e.on("focusout", (t) => {
            wf.setEditorTimeout(
    ...
    uF = (e, t) => (o) => {
      ...
      return (
        ...
        pS(() => e.off("PastePlainTextToggle", n), hS(e)(o))
      )
    },
    mF = (e, t) => () => {
    ...
    pF = (e, t) =>
      bS(e, "Undo Redo AddUndo TypingUndo ClearUndos SwitchMode", (o) => {
      ...
      ;((e) => {
        ...
        ((e) => {
          ...
          const t = zS(e),
            ...
            n = en(t),
            s = en(o)
          YS(e, "forecolor", "forecolor", n),
            YS(e, "backcolor", "hilitecolor", s),
            XS(e, "forecolor", "forecolor", "Text color", n),
            XS(e, "backcolor", "hilitecolor", "Background color", s)
        })(e),
        ((e) => {
          ;((e) => {
            e.ui.registry.addButton("visualaid", {
              tooltip: "Visual aids",
              text: "Visual aids",
              onAction: xS(e, "mceToggleVisualAid"),
              context: "any",
            })
          })(e),
            ((e) => {
        ...
        ((e) => {
          ;((e) => {
            e.ui.registry.addButton("outdent", {
              ...
              icon: "outdent",
              onSetup: dF(e),
              onAction: xS(e, "outdent"),
            }),
              e.ui.registry.addButton("indent", {
                tooltip: "Increase indent",
                icon: "indent",
                onSetup: hS(e),
                onAction: xS(e, "indent"),
              })
          })(e)
        })(e),
        cF(e),
      ...
      "contextmenu" === t.type || "longpress" === t.type
        ? e.inline
          ? ((e) => {
              if (CF(e)) {
                const t = e.touches[0]
                return SF(t.pageX, t.pageY)
              }
              return SF(e.pageX, e.pageY)
            })(t)
          : ((e, t) => {
              const o = Sf.DOM.getPos(e)
              return ((e, t, o) => SF(e.x + t, e.y + o))(t, o.x, o.y)
            })(
              e.getContentAreaContainer(),
              ((e) => {
                if (CF(e)) {
                  const t = e.touches[0]
                  return SF(t.clientX, t.clientY)
                }
                return SF(e.clientX, e.clientY)
              })(t),
            )
        : OF(e),
    OF = (e) => ({ type: "selection", root: ze(e.selection.getNode()) }),
    _F = (e, t, o) => {
      switch (o) {
        case "node":
          return ((e) => ({
      ...
      OT(a, mx.CLOSE_ON_EXECUTE, n, {
        ...
        t.preventDefault(),
          vf.showMenuAt(
            s,
            { anchor: i },
            { menu: { markers: Tx("normal") }, data: e },
          )
      })
    },
    EF = {
      onLtr: () => [Zl, Yl, Xl, Kl, Jl, Ql, mA, gA, uA, cA, dA, lA],
      onRtl: () => [Zl, Xl, Yl, Jl, Kl, Ql, mA, gA, dA, lA, uA, cA],
    },
    AF = {
      valignCentre: [],
      alignCentre: [],
        ...
        u = () => {
          ...
          ;((e, t, o, n, s, r, a) => {
            const i = ((e, t, o) => {
              const n = _F(e, t, o)
              return {
                bubble: Wc(0, "point" === o ? 12 : 0, AF),
                layouts: EF,
                overrides: { maxWidthFunction: gD(), maxHeightFunction: Lc() },
                ...n,
              }
            })(e, t, r)
            OT(o, mx.CLOSE_ON_EXECUTE, n, {
              isHorizontalMenu: !0,
              search: A.none(),
            }).map((o) => {
              t.preventDefault()
              const l = a ? hf.HighlightMenuAndItem : hf.HighlightNone
              vf.showMenuWithinBounds(
                s,
                { anchor: i },
                {
                  menu: { markers: Tx("normal"), highlightOnOpen: l },
                  data: o,
                  type: "horizontal",
                },
                () =>
                  A.some(QI(e, n.shared, "node" === r ? "node" : "selection")),
              ),
                e.dispatch(FI)
            })
          })(e, t, a, n, s, r, !(c || i || (l && d)))
    ...
    FF = (e, t) => {
      ...
      return e.concat(o).concat(t).concat([BF])
    },
    RF = (e, t) =>
      !((e) => "longpress" === e.type || be(e, "touches"))(t) &&
      (2 !== t.button || (t.target === e.getBody() && "" === t.pointerType)),
    NF = (e, t) => (RF(e, t) ? e.selection.getStart(!0) : t.target),
    zF = (e, t, o) => {
      const n = Mo().deviceType.isTouch,
        ...
        i = (t) => {
          ...
          const a = ((e, t) => {
            const o = yF(e),
              n = RF(e, t) ? "selection" : "point"
            if (Me(o)) {
              const s = NF(e, t)
              return PC(ze(s), o) ? "node" : n
            }
            return n
          })(e, t)
          ;(n() ? MF : TF)(
            ...
            () => {
              ...
              return ((e, t, o) => {
                const n = W(
                  ...
                  (t, n) =>
                    fe(e, n.toLowerCase())
                      .map((e) => {
                        const n = e.update(o)
                        if (r(n) && Me(Ae(n))) return FF(t, n.split(" "))
                        if (l(n) && n.length > 0) {
                          const e = V(n, IF)
                          return FF(t, e)
                        }
                ...
                return n.length > 0 && DF(n[n.length - 1]) && n.pop(), n
              })(n.contextMenus, s, o)
            },
            o,
            s,
    ...
    HF = (e) => (t) => t.translate(e.left, e.top),
    PF = (e) => (t, o) => W(e, (e, t) => t(e), $t(t, o)),
    UF = (e, t, o) => e.fold(PF([HF(o), LF(t)]), PF([LF(t)]), PF([])),
    WF = (e, t, o) => e.fold(PF([HF(o)]), PF([]), PF([HF(t)])),
    jF = (e, t, o) => e.fold(PF([]), PF([LF(o)]), PF([HF(t), LF(o)])),
    $F = (e, t, o) => {
      const n = e.fold(
        (e, t) => ({
    ...
    GF = (e, t, o, n) => {
      ...
      return e.fold(s(jF, qF), s(WF, YF), s(UF, XF))
    },
    qF = VF.offset,
    YF = VF.absolute,
    XF = VF.fixed,
    ...
    JF = (e, t, o, n, s, r) => {
      const a = ((e, t, o, n) =>
        ...
        i = t.mustSnap ? ZF(e, t, a, s, r) : eR(e, t, a, s, r),
        l = UF(a, s, r)
      return (
        ((e, t, o) => {
          const n = e.element
  ...
  const iR = [
    ...
    lR = (e) => {
      ...
      t.isSome() && o.isSome() && n.isSome()
        ? A.some(
            ((e, t, o) =>
              ("fixed" === o ? XF : qF)(parseInt(e, 10), parseInt(t, 10)))(
              t.getOrDie(),
              o.getOrDie(),
              n.getOrDie(),
            ),
    ...
    dR = (e, t, o, n, s) => {
      const r = o.update(n, s),
        a = o.getStartData().getOrThunk(() => cR(t, e))
      r.each((o) => {
        ;((e, t, o, n) => {
          const s = t.getTarget(e.element)
          if (t.repositionTarget) {
  ...
  const pR = (e, t, o) => [
    ...
    hR = [...iR, wi("dragger", { handlers: mR(pR) })]
  ...
  const bR = (e, t, o) => {
    ...
    vR = hR,
    xR = [...iR, wi("dragger", { handlers: mR(bR) })],
    yR = [
      ...iR,
      wi("dragger", {
        handlers: mR((e, t, o) => [...pR(e, t, o), ...bR(e, t, o)]),
      }),
    ]
  ...
  const CR = ga({
    ...
    TR = (e, t) => {
      const o = en([]),
        ...
        i = (e) => {
          const o = Jo(e)
          return kR(u.getOpt(t), e, o.x, o.y, o.width, o.height)
        },
        l = (e) => {
          const o = Jo(e)
          return kR(m.getOpt(t), e, o.right, o.bottom, o.width, o.height)
        },
        c = OR(
          () => V(o.get(), (e) => i(e)),
          r,
    ...
    ER = (e, t, o) => {
      ...
      return {
        ...
        behaviours: ca([
          ...
          Ow(() => o.checkUiComponentContext("any")),
          Pb.config({}),
          _h.config({}),
  ...
  const MR = (e, t, o) => {
      const n = ze(e.getContainer()),
        s = ((e, t, o, n, s) => {
          const r = { height: TI(n + t.top, If(e), Rf(e)) }
          return o === AR.Both && (r.width = TI(s + t.left, Bf(e), Ff(e))), r
        })(e, t, o, Ut(n), Kt(n))
      ie(s, (e, t) => {
        h(e) && Mt(n, t, _I(e))
      }),
            ...
            o.push(
              (() => {
                ...
                return {
                  ...
                  components: [dl(Qv.translate(["Press {0} for help", e]))],
                }
              })(),
            ),
          r &&
                    ...
                    o.push(
                      ((e, t) => {
                        ...
                        return Nb.sketch({
                          ...
                          buttonBehaviours: ca([
                            gw(t.isDisabled),
                            Ow(() => t.checkUiComponentContext("any")),
                            Pb.config({}),
                            _h.config({}),
                            ju.config({
                              store: {
                            ...
                            Th("wordcount-events", [
                              ea((e) => {
                                ...
                                ju.setValue(e, { mode: n, count: t.count }),
                                  o(e, t.count, n)
                              }),
                              Jr((t) => {
                                e.on("wordCountUpdate", (e) => {
                                  const { mode: n } = ju.getValue(t)
                                  ju.setValue(t, {
                                    mode: n,
                                    count: e.wordCount,
                                  }),
        ...
        components: (() => {
          const n = o(),
            s = ((e, t) => {
              const o = ((e) => {
                const t = ib(e)
                return !1 === t ? AR.None : "both" === t ? AR.Both : AR.Vertical
              })(e)
              if (o === AR.None) return A.none()
              const n =
                o === AR.Both
    ...
    FR = (e, t) => {
      const o = e.inline,
        ...
        b = r.lazyGetInOuterOrDie("toolbar", dB.getToolbar),
        v = r.lazyGetInOuterOrDie("throbber", dB.getThrobber),
        x = ((e, t, o, n) => {
          const s = en(!1),
            r = ((e) => {
            ...
            a = {
              ...
              translate: Qv.translate,
              isDisabled: () => !t.ui.isEnabled(),
              getOption: t.options.get,
              tooltips: LA(e.dialog),
              checkUiComponentContext: (e) => {
                if (Af(t)) return { contextType: "disabled", shouldDisable: !0 }
                const [o, n = ""] = e.split(":"),
            ...
            c = ((e) => ({
              colorPicker: TA(e),
              hasCustomColors: EA(e),
              getColors: AA(e),
              getColorCols: MA(e),
            }))(t),
            d = ((e) => ({ isDraggableModal: DA(e) }))(t),
            u = {
              shared: {
                providers: a,
                anchors: _A(t, o, n, r.isPositionedAtTop),
                header: r,
              },
              urlinput: i,
              styles: l,
        ...
        y = () => {
          const t = (() => {
              const t = {
                ...
                i = hb(e),
                l = db(e),
                c = dB.parts.promotion({
                  dom: { tag: "div", classes: ["tox-promotion"] },
                }),
                g = r || a || i,
                h = l ? [c, o] : [o]
              return dB.parts.header({
                dom: {
                  tag: "div",
            ...
            r = dB.parts.viewWrapper({ backstage: x.popup }),
            i =
              sb(e) && !o ? A.some(BR(e, x.popup.shared.providers)) : A.none(),
            l = G([d ? [] : [t], o ? [] : [n], d ? [t] : []]),
            h = dB.parts.editorContainer({
            ...
            ;(f = o.outerContainer),
              ...
              e.addCommand("ToggleToolbarDrawer", (e, t) => {
                ;(null == t ? void 0 : t.skipFocus)
                  ? dB.toggleToolbarDrawerWithoutFocusing(f)
                  : dB.toggleToolbarDrawer(f)
              }),
              e.addQueryStateHandler("ToggleToolbarDrawer", () =>
                dB.isToolbarDrawerToggled(f),
              ),
              ((e, t, o) => {
                const n = (e, n) => {
                    L([t, ...o], (t) => {
              ...
              fF(e, x.popup),
              zF(e, x.popup.shared.getSink, x.popup),
              ((e) => {
              ...
              sD(e, v, x.popup.shared),
              iF(e, c, r.sink, { backstage: x.popup }),
              TR(e, r.sink)
            const b = {
    ...
    zR = y([
      ...
      vm({ factory: NR, schema: [rs("dom")], name: "close" }),
      vm({ factory: NR, schema: [rs("dom")], name: "body" }),
      ym({ factory: NR, schema: [rs("dom")], name: "footer" }),
      xm({
        factory: {
    ...
    UR = [...PR, oy],
    WR = [ls("type", ["submit", "cancel", "custom"]), ...UR],
    jR = [ls("type", ["menu"]), my, hy, py, ms("items", LR), ...PR],
    $R = [...PR, ls("type", ["togglebutton"]), hy, py, my, _s("active", !1)],
    GR = es("type", {
      submit: WR,
      cancel: WR,
      custom: WR,
    ...
    JR = [Zx, ey],
    QR = JR.concat([fy]),
    ZR = JR.concat([ty, wy, ks("context", "mode:design")]),
    eN = Fn(ZR),
    tN = Wn,
    oN = QR.concat([Cy("auto"), ks("context", "mode:design")]),
    nN = Fn(oN),
    sN = Vn([ry, oy, sy]),
    rN = QR.concat([ks("storageKey", "default"), ks("context", "mode:design")]),
    aN = Fn(rN),
    iN = Un,
    lN = Fn(QR),
    cN = Un,
    ...
    uN = JR.concat([ks("tag", "textarea"), cs("init")]),
    mN = Yn((e) =>
      Kn("customeditor.old", In(uN), e).orThunk(() =>
        Kn("customeditor.new", In(dN), e),
      ),
    ),
    gN = Un,
    pN = QR.concat([ks("context", "mode:design")]),
    hN = Fn(pN),
    fN = Rn(En),
    bN = (e) => [Zx, ("columns", as("columns", Pn)), e],
    vN = [
      Zx,
      is("html"),
    ...
    wN = Fn(yN),
    SN = Un,
    CN = Fn(JR.concat([fs("height")])),
    kN = Fn([is("url"), hs("zoom"), hs("cachedWidth"), hs("cachedHeight")]),
    ON = QR.concat([
      fs("inputMode"),
      fs("placeholder"),
      _s("maximized", !1),
    ...
    DN = Nn([Fn(AN), Fn(MN)]),
    BN = QR.concat([ms("items", DN), wy, ks("context", "mode:design")]),
    IN = Fn(BN),
    FN = Un,
    RN = QR.concat([
      us("items", [oy, ry]),
    ...
    NN = Fn(RN),
    zN = Un,
    VN = QR.concat([_s("constrain", !0), wy, ks("context", "mode:design")]),
    LN = Fn(VN),
    HN = Fn([is("width"), is("height")]),
    PN = JR.concat([ty, Cs("min", 0), Cs("max", 0)]),
    UN = Fn(PN),
    WN = Pn,
    jN = [Zx, ms("header", Un), ms("cells", Rn(Un))],
    $N = Fn(jN),
    GN = QR.concat([
      fs("placeholder"),
      _s("maximized", !1),
    ...
    JN = XN.concat([
      ms(
        "children",
        ts(0, () => qn("type", { directory: QN, leaf: KN })),
      ),
    ]),
    QN = Fn(JN),
    ZN = qn("type", { directory: QN, leaf: KN }),
    ez = [
      Zx,
      ms("items", ZN),
      vs("onLeafAction"),
    ...
    rz = (e) =>
      os(
        ...
        Rn(
          Yn((t) =>
            Kn(`Checking item of ${e}`, az, t).fold(
              (e) => ln.error(Zn(e)),
              (e) => ln.value(e),
            ),
          ),
    ...
    iz = [Zx, ws("classes", []), ms("items", az)],
    lz = Fn(iz),
    cz = [Ty("tab"), ny, ms("items", az)],
    dz = [Zx, us("tabs", cz)],
    uz = Fn(dz),
    mz = UR,
    gz = GR,
    pz = Fn([
      is("title"),
      as("body", qn("type", { panel: lz, tabpanel: uz })),
      ks("size", "normal"),
      Es("buttons", [], gz),
      ws("initialData", {}),
      Ts("onAction", b),
    ...
    hz = Fn([ls("type", ["cancel", "custom"]), ...mz]),
    fz = Fn([
      is("title"),
      is("url"),
      hs("height"),
    ...
    yz = (e) => {
      const t = ((e) => P(bz(e), vz))(e),
        o = q(t, (e) =>
          ((e) => A.from(xz[e.type]))(e).fold(
            () => [],
            (t) => [as(e.name, t)],
          ),
        )
    ...
    wz = (e) => {
      var t
      return {
        internalDialog: Jn(Kn("dialog", pz, e)),
        dataValidator: yz(e),
    ...
    Sz = {
      ...
      openUrl: (e, t) => e(Jn(Kn("dialog", fz, t))),
      redial: (e) => wz(e),
    }
  var Cz = Object.freeze({
      __proto__: null,
      events: (e, t) => {
        const o = (o, n) => {
    ...
    kz = Object.freeze({ __proto__: null, getState: (e, t, o) => o }),
    Oz = [
      rs("channel"),
      gs("renderComponents"),
      gs("updateState"),
  ...
  const _z = ua({
    ...
    Ez = (e, t, o, n) => {
      const s = Vb(
        w_.sketch((s) => ({
          ...
          components: V(e.items, (e) => QE(s, e, t, o, n)),
        })),
      )
      return {
        ...
        behaviours: ca([
          bh.config({ mode: "acyclic", useTabstopAt: k(X_) }),
          ((r = s), Jm.config({ find: r.getOpt })),
          B_(s, {
            postprocess: (e) => Tz(e).fold((e) => (console.error(e), {}), w),
          }),
          Th("dialog-body-panel", [
            Wr(Xs(), (e, t) => {
              e.getSystem().broadcastOn([tT], {
    ...
    Az = Gm({
      ...
      configFields: [
        ...
        gs("action"),
        ws("domModification", {}),
        $u("tabButtonBehaviours", [Bh, bh, ju]),
        rs("view"),
      ],
      factory: (e, t) => ({
        uid: e.uid,
          ...
          apis: {
            ...
            showTab: (e, t) => {
              s(e, (e) => {
                ...
                return j(o, (e) => ju.getValue(e) === t).filter(
    ...
    $z = (e, t, o, n) => {
              ...
              Jr((o) => {
                ...
                Uz(n).each((s) => {
                  Mt(s, "visibility", "hidden"),
                    ...
                    Vt(s, "visibility"),
                    ((e, t) => {
                      te(e).each((e) => Lz.showTab(t, e.value))
                    })(e, o),
                    requestAnimationFrame(() => {
                      Pz(n, s, t)
                    })
      ...
      return Lz.sketch({
        ...
        onChangeTab: (e, t, o) => {
          const n = ju.getValue(t)
          Rr(e, hk, { name: n, oldName: i.get() }), i.set(n)
        },
        tabs: l,
        components: [
          Lz.parts.tabbar({
        ...
        tabSectionBehaviours: ca([
          ...
          bh.config({ mode: "acyclic" }),
          Jm.config({ find: (e) => te(Lz.getViewItems(e)) }),
          I_(
            A.none(),
            (e) => (e.getSystem().broadcastOn([Wz], {}), s.get()),
            (e, t) => {
    ...
    Jz = (e, t) =>
      VR.parts.body({
        ...
        components: [
          {
            dom: { tag: "div", classes: ["tox-dialog__body-content"] },
            components: [{ dom: zb(`<p>${Jv(t.translate(e))}</p>`) }],
          },
        ],
      }),
    Qz = (e) =>
      ...
      return VR.sketch({
        ...
        parts: {
          blocker: {
            ...
            components: [
              { dom: { tag: "div", classes: qz ? [n, n + "--opaque"] : [n] } },
            ],
          },
        },
        dragBlockClass: o,
        modalBehaviours: ca([
          ...
          Th(
            ...
            e.dialogEvents.concat([
              Kr(Xs(), (e, t) => {
                oD.isBlocked(e) || bh.focusIn(e)
              }),
              Wr(Tr(), (e, t) => {
                e.getSystem().broadcastOn([tT], { newFocus: t.event.newFocus })
              }),
            ]),
          ),
          Th("scroll-lock", [
    ...
    tV = (e) =>
      Nb.sketch({
        ...
        components: [
          ix("close", { tag: "span", classes: ["tox-icon"] }, e.icons),
        ],
        action: (e) => {
          Fr(e, dk)
        },
    ...
    nV = () => ({ dom: zb('<div class="tox-dialog__draghandle"></div>') }),
    sV = (e, t, o) =>
      ((e, t, o) => {
        const n = VR.parts.title(oV(e, t, A.none(), o)),
          s = VR.parts.draghandle(nV()),
          r = VR.parts.close(tV(o)),
    ...
    aV = (e, t, o) => ({
      ...
      onBlock: (o) => {
        ...
        VR.setBusy(e(), (e, s) => rV(o.message, s, t, n))
      },
      onUnblock: () => {
        VR.setIdle(e())
      },
    }),
    iV = "tox-dialog--fullscreen",
    lV = "tox-dialog--width-lg",
    cV = "tox-dialog--width-md",
    dV = (e) => {
      switch (e) {
        case "large":
          return A.some(lV)
    ...
    uV = (e, t) => {
      ...
      Ca(o, iV) || (Oa(o, [lV, cV]), dV(e).each((e) => ya(o, e)))
    },
    mV = (e, t) => {
      const o = ze(e.element.dom),
        n = _a(o),
        s = j(n, (e) => e === lV || e === cV).or(dV(t))
      ;((e, t) => {
        L(t, (t) => {
          ;((e, t) => {
            const o = fa(e)
    ...
    gV = (e, t, o) =>
      pl(
        eV({
          ...
          extraBehaviours: [R_({}), ...e.extraBehaviours],
          onEscape: (e) => {
            Fr(e, dk)
          },
          dialogEvents: t,
    ...
    fV = (e, t) => [
      ...
      e(dk, (e, t, o, n) => {
        t.onCancel(e), Fr(n, ck)
      }),
      Wr(pk, (e, o) => t.onUnblock()),
      Wr(gk, (e, o) => t.onBlock(o.event)),
    ],
    bV = (e, t, o) => {
      const n = (t, o) =>
          Wr(t, (t, n) => {
        ...
        _z.config({
          ...
          updateState: (e, t) => {
            const n = V(t.buttons, (e) => {
              const t = Vb(((e, t) => NE(e, e.type, t))(e, o))
    ...
    yV = (e, t, o) => VR.parts.footer(xV(e, t, o)),
    wV = (e, t) => {
      if (e.getRoot().getSystem().isConnected()) {
        const o = Jm.getCurrent(e.getFormWrapper()).getOr(e.getFormWrapper())
        return w_.getField(o, t).orThunk(() => {
          const o = e.getFooter().bind((e) => _z.getState(e).get())
      ...
      const n = (t) => {
        ...
        s = {
          getData: () => {
            ...
            return { ...ju.getValue(n), ...le(o, (e) => e.get()) }
          },
          setData: (t) => {
            n((n) => {
              const r = s.getData(),
          ...
          setEnabled: (t, o) => {
            wV(e, t).each(o ? ug.enable : ug.disable)
          },
          focus: (t) => {
            wV(e, t).each(Bh.focus)
          },
          block: (e) => {
            if (!r(e))
              throw new Error(
          ...
          redial: (r) => {
            n((n) => {
              const a = e.getId(),
                i = t(r),
                l = pV(i.internalDialog.buttons, o)
              n.getSystem().broadcastOn([`${K_}-${a}`], i),
                n.getSystem().broadcastOn([`${J_}-${a}`], i.internalDialog),
    ...
    CV = (e, t, o, n = !1, s) => {
      const r = Di("dialog"),
        ...
        m = Vb(
          ((e, t, o, n, s, r) => Gz(e, t, A.some(o), n, s, r))(
        ...
        h = Ce(
          0 !== g.length,
          Vb(((e, t, o) => xV(e, t, o))({ buttons: g }, r, o)),
        ),
        f = bV(
          () => w,
          {
  ...
  var kV = tinymce.util.Tools.resolve("tinymce.util.URI")
  const OV = [
      "insertContent",
      "setContent",
      "execCommand",
    ...
    _V = (e) => a(e) && -1 !== OV.indexOf(e.mceAction),
    TV = (e, t, o, n) => {
      const s = Di("dialog"),
        i = sV(e.title, s, n),
        l = ((e) => {
          ...
          return VR.parts.body(t)
        })(e),
        c = e.buttons.bind((e) =>
          0 === e.length ? A.none() : A.some(yV({ buttons: e }, s, n)),
        ),
        u = ((e, t) => {
          const o = (e, t) =>
              Wr(e, (e, o) => {
        ...
        h = new kV(e.url, { base_uri: new kV(window.location.href) }),
          ...
          Th("messages", [
            Jr(() => {
              const t = Dc(ze(window), "message", (t) => {
                if (h.isSameOrigin(new kV(t.raw.origin))) {
                  const n = t.raw.data
                  _V(n)
                    ? ((e, t, o) => {
                        switch (o.mceAction) {
    ...
    EV = (e, t) => Jn(Kn("data", t, e)),
    AV = (e) => PC(e, ".tox-alert-dialog") || PC(e, ".tox-confirm-dialog"),
    MV = (e, t, o) =>
      t && o
        ? []
        : [
      ...
      const t = e.editor,
              ...
              const s = () => {
                ...
                l = pl(
                  eV({
                    lazySink: () => t.getSink(),
                    header: Yz(a, i),
                    body: Jz(o, t.providers),
                    footer: A.some(Qz(Zz([], [r.asSpec()]))),
                    onEscape: s,
                    extraClasses: ["tox-alert-dialog"],
                    extraBehaviours: [],
                    extraStyles: {},
                    dialogEvents: [Wr(dk, s)],
                    eventOrder: {},
                  }),
                )
              VR.show(l)
          ...
          return {
            open: (o, n) => {
              const s = (e) => {
                ...
                i = Kz(),
                l = Xz(() => s(!1), t.providers),
                c = pl(
                  eV({
                    lazySink: () => t.getSink(),
                    header: Yz(i, l),
                    body: Jz(o, t.providers),
                    footer: A.some(Qz(Zz([], [a, r.asSpec()]))),
                    onEscape: () => s(!1),
                    extraClasses: ["tox-confirm-dialog"],
                    extraBehaviours: [],
                    extraStyles: {},
                    dialogEvents: [Wr(dk, () => s(!1)), Wr(mk, () => s(!0))],
                    eventOrder: {},
                  }),
                )
              VR.show(c)
            ...
            const r = n,
              a = ((e, t, o) => {
                const n = Di("dialog"),
                  ...
                  i = dV(a.get()).toArray(),
                  l = ((e, t, o, n) => {
                    const s = Gz(e, t, A.none(), o, !1, n)
                    return VR.parts.body(s)
                  })({ body: s.body, initialData: s.initialData }, n, o, (e) =>
                    wV(h, e),
                  ),
                  c = pV(s.buttons),
                  d = hV(c),
                  u = Ce(0 !== c.length, yV({ buttons: c }, n, o)),
                  m = bV(
                    () => f,
                    aV(() => p, o.shared.providers, t),
                    o.shared.getSink,
                  ),
                  g = {
                    id: n,
                  ...
                  h = {
                    getId: y(n),
                    getRoot: y(p),
                    getBody: () => VR.getBody(p),
                    getFooter: () => VR.getFooter(p),
                    getFormWrapper: () => {
                      const e = VR.getBody(p)
                      return Jm.getCurrent(e).getOr(e)
                    },
                    toggleFullscreen: () => {
                      mV(p, a.get())
                ...
                { dataValidator: s, initialData: r, internalDialog: t },
                {
                  redial: Sz.redial,
                  closeWindow: () => {
                    VR.hide(a.dialog), o(a.instanceApi)
                  },
                },
                e.backstages.dialog,
              )
            return VR.show(a.dialog), a.instanceApi.setData(r), a.instanceApi
          }, t),
        a = (n, s, r, a) =>
          Sz.open((n, i, l) => {
            const c = EV(i, l),
              ...
              p = pl(
                vf.sketch({
                  ...
                  isExtraPart: (e, t) => AV(t),
                }),
              )
            return (
              d.set(p),
              vf.showWithinBounds(p, hl(g.dialog), { anchor: s }, () => {
        ...
        i = (o, n, s, r) =>
          Sz.open((o, a, i) => {
            ...
            return (
              c.set(g),
              vf.showWithinBounds(g, hl(m.dialog), { anchor: n }, () =>
          ...
          ((o, n) =>
            Sz.openUrl((o) => {
              const s = TV(
                ...
                {
                  closeWindow: () => {
                    VR.hide(s.dialog), n(s.instanceApi)
                  },
                },
                t,
                e.backstages.dialog,
              )
              return VR.show(s.dialog), s.instanceApi
            }, o))(o, n),
        alert: (e, t) => {
          n.open(e, t)
        },
      ...
      Tf(e),
        ((e) => {
          ...
          t("color_map", {
            ...
            t("color_cols_foreground", { processor: n, default: FS(e, TS) }),
            t("color_cols_background", { processor: n, default: FS(e, ES) }),
            t("custom_colors", { processor: "boolean", default: !0 }),
            t("color_default_foreground", { processor: "string", default: DS }),
            t("color_default_background", { processor: "string", default: DS })
        })(e),
        ((e) => {
          const t = e.options.register
  ...
  sn.add("silver", (e) => {
    ...
    const {
      ...
      popups: n,
      renderUI: s,
    } = FR(e, { getPopupSinkBounds: () => t() })
    HC(e, n.backstage.shared)
    const r = DV({
        editor: e,
    ...
    return {
      ...
      getNotificationManagerImpl: () =>
        dx(e, { backstage: n.backstage }, n.getMothership(), a),
    }
  })
})()
